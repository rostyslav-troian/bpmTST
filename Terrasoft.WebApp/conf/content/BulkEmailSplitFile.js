define("BulkEmailSplitFile", ["terrasoft", "ext-base", "BulkEmailSplitFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BulkEmailSplitFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BulkEmailSplitFile",
			singleton: true,
			uId: "18ff8448-3fde-4a32-b5ec-9e5b9f8ecc74",
			name: "BulkEmailSplitFile",
			caption: resources.localizableStrings.BulkEmailSplitFileCaption,
			...
			columns: {
				...
				BulkEmailSplit: {
					uId: "1c24c8e1-1101-425d-8209-c58bcd1137cc",
					name: "BulkEmailSplit",
		...
		return Terrasoft.BulkEmailSplitFile;
	});