define("AccountForecast", ["terrasoft", "ext-base", "AccountForecastResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.AccountForecast", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.AccountForecast",
			singleton: true,
			uId: "74900c50-b7e7-452a-83d9-f98707756d6c",
			name: "AccountForecast",
			caption: resources.localizableStrings.AccountForecastCaption,
			...
			columns: {
				...
				Account: {
					uId: "570b82b1-62e9-46b8-b98d-55c7a903e7d8",
					name: "Account",
		...
		return Terrasoft.AccountForecast;
	});