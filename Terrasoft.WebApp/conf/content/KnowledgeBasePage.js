Terrasoft.configuration.Structures["KnowledgeBasePage"] = {innerHierarchyStack: ["KnowledgeBasePageNUI", "KnowledgeBasePage", "KnowledgeBasePage"]};
define('KnowledgeBasePageNUIStructure', function() {return {type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
define('KnowledgeBasePageStructure', ['KnowledgeBasePageResources'], function(resources) {return {schemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',schemaCaption: "Page - Knowledge base", parentSchemaName: "KnowledgeBasePageNUI", schemaName:'KnowledgeBasePage',parentSchemaUId:'49167555-fc46-4762-87a5-a1b7830f8457',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"KnowledgeBasePageNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('KnowledgeBasePageStructure', ['KnowledgeBasePageResources'], function(resources) {return {schemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',schemaCaption: "Page - Knowledge base", parentSchemaName: "KnowledgeBasePage", schemaName:'KnowledgeBasePage',parentSchemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"KnowledgeBasePage",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('KnowledgeBasePageNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("KnowledgeBasePageNUI", ['ext-base', 'terrasoft', 'sandbox', 'KnowledgeBase', "KnowledgeBasePageNUIStructure",
	'KnowledgeBasePageNUIResources', 'GeneralDetails', 'ConfigurationEnums', 'KnowledgeBaseTag',
