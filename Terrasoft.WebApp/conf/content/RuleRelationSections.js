define("RuleRelationSections", ["terrasoft", "ext-base", "RuleRelationSectionsResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.RuleRelationSections", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.RuleRelationSections",
			singleton: true,
			uId: "adc2e665-7f74-49ee-a3d1-d63482aec3f6",
			name: "RuleRelationSections",
			caption: resources.localizableStrings.RuleRelationSectionsCaption,
			...
			columns: {
				...
				SectionSchemaUId: {
					uId: "b2e3a06a-cb04-4642-8735-e116e955de07",
		...
		return Terrasoft.RuleRelationSections;
	});