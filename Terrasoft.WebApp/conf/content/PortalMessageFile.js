define("PortalMessageFile", ["terrasoft", "ext-base", "PortalMessageFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.PortalMessageFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.PortalMessageFile",
			singleton: true,
			uId: "55c1fe71-17a1-4bd2-a4b2-7799ccaac996",
			name: "PortalMessageFile",
			caption: resources.localizableStrings.PortalMessageFileCaption,
			...
			columns: {
				...
				PortalMessage: {
					uId: "f9baa4fa-e177-4765-95f6-393d923c0283",
					name: "PortalMessage",
					...
					isValueCloneable: true,
					isLookup: true,
					referenceSchemaName: "PortalMessage",
					referenceSchema: {
						name: "PortalMessage",
						primaryColumnName: "Id",
		...
		return Terrasoft.PortalMessageFile;
	});