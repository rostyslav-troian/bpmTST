define("BaseLczEntity", ["terrasoft", "ext-base", "BaseLczEntityResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseLczEntity", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseLczEntity",
			singleton: true,
			uId: "b7cd8e8f-a017-4f73-b1fe-efb9e938e1d2",
			name: "BaseLczEntity",
			caption: resources.localizableStrings.BaseLczEntityCaption,
			...
			columns: {
				...
				Record: {
					...
					isValueCloneable: true,
					isLookup: true,
					referenceSchemaName: "BaseLookup",
					referenceSchema: {
						name: "BaseLookup",
						primaryColumnName: "Id",
						primaryDisplayColumnName: "Name"
		...
		return Terrasoft.BaseLczEntity;
	});