Terrasoft.configuration.Structures["CommunicationDetail"] = {innerHierarchyStack: ["CommunicationDetail"]};
define('CommunicationDetailStructure', ['CommunicationDetailResources'], function(resources) {return {type:Terrasoft.SchemaType.EDIT_CONTROLS_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{attributes:[]},methods:{},schemaDifferences:function(){
