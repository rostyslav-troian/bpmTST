Terrasoft.configuration.Structures["ContactCareerPageInAccount"] = {innerHierarchyStack: ["ContactCareerPageInAccount"]};
define('ContactCareerPageInAccountStructure', function() {return {type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
define("ContactCareerPageInAccount", ['ext-base', 'terrasoft', 'sandbox', 'ContactCareer',
	"ContactCareerPageInAccountStructure", 'ContactCareerPageInAccountResources'],
			...
			this.methods = {
				...
				save: function() {
					...
					if (current && primary) {
						...
						if (contact) {
							this.getContactCareerCollection(contact.value);
						}
					} else {
