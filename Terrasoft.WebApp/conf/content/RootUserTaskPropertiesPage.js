Terrasoft.configuration.Structures["RootUserTaskPropertiesPage"] = {innerHierarchyStack: ["RootUserTaskPropertiesPage"], structureParent: "ProcessFlowElementPropertiesPage"};
define('RootUserTaskPropertiesPageStructure', ['RootUserTaskPropertiesPageResources'], function(resources) {return {schemaUId:'9ba919f3-0101-4b63-93c5-1a453985b538',schemaCaption: "RootUserTaskPropertiesPage", parentSchemaName: "ProcessFlowElementPropertiesPage", schemaName:'RootUserTaskPropertiesPage',parentSchemaUId:'0f347363-31e5-4222-a82e-dcfeda34cbb6',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
	...
	function(resources, sourceCodeEditEnums) {
		return {
			...
			methods: {
				 ...
				 * @protected
				 */
				onAfterSchemaChanged: Terrasoft.emptyFn,
				...
				synchronizeSchemaParameter: function(element, newParameter, oldParameter) {
					if (newParameter && newParameter.dataValueType === oldParameter.dataValueType) {
						var newUId = newParameter.uId;
						element.parameters.removeByKey(newUId);
						var oldUID = oldParameter.uId;
						newParameter.uId = oldUID;
						element.parameters.add(oldUID, newParameter);
