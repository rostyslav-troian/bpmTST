define("AccountFile", ["terrasoft", "ext-base", "AccountFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.AccountFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.AccountFile",
			singleton: true,
			uId: "149d2eaf-cbd2-49fa-b565-637748ff823c",
			name: "AccountFile",
			caption: resources.localizableStrings.AccountFileCaption,
			...
			columns: {
				...
				Account: {
					uId: "873d6499-a9b4-418b-b63a-804a71a2fbfe",
					name: "Account",
