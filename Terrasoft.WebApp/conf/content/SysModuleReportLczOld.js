define("SysModuleReportLczOld", ["terrasoft", "ext-base", "SysModuleReportLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleReportLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleReportLczOld",
			singleton: true,
			uId: "f92f7ed4-6682-4428-b25f-4995e7dc4695",
			name: "SysModuleReportLczOld",
			caption: resources.localizableStrings.SysModuleReportLczOldCaption,
		...
		return Terrasoft.SysModuleReportLczOld;
	});