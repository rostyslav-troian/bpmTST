define("ProductFile", ["terrasoft", "ext-base", "ProductFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ProductFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ProductFile",
			singleton: true,
			uId: "80ccf8ab-2514-49ce-adea-3de1b6f249e3",
			name: "ProductFile",
			caption: resources.localizableStrings.ProductFileCaption,
			...
			columns: {
				...
				Product: {
					uId: "9590f798-1c5f-4933-927c-48da921c2cc2",
					name: "Product",
