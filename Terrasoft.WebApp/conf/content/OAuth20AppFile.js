define("OAuth20AppFile", ["terrasoft", "ext-base", "OAuth20AppFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.OAuth20AppFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.OAuth20AppFile",
			singleton: true,
			uId: "df2132c7-b45d-455e-a24a-5936c898dca1",
			name: "OAuth20AppFile",
			caption: resources.localizableStrings.OAuth20AppFileCaption,
			...
			columns: {
				...
				OAuth20App: {
					uId: "eab4dc61-7070-4d23-9d3e-9e75e07a3b9f",
					name: "OAuth20App",
		...
		return Terrasoft.OAuth20AppFile;
	});