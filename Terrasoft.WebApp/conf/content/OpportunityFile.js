define("OpportunityFile", ["terrasoft", "ext-base", "OpportunityFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.OpportunityFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.OpportunityFile",
			singleton: true,
			uId: "4135a9ba-5936-438f-9795-40fbc090c07b",
			name: "OpportunityFile",
			caption: resources.localizableStrings.OpportunityFileCaption,
			...
			columns: {
				...
				Opportunity: {
					uId: "5e3c0aab-bd70-4f36-bf97-aea890d392a3",
					name: "Opportunity",
		...
		return Terrasoft.OpportunityFile;
	});