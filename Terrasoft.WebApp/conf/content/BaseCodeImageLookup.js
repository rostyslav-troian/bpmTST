define("BaseCodeImageLookup", ["terrasoft", "ext-base", "BaseCodeImageLookupResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseCodeImageLookup", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseCodeImageLookup",
			singleton: true,
			uId: "c21771d2-01fa-4646-96b0-e4b69e582b44",
			name: "BaseCodeImageLookup",
			caption: resources.localizableStrings.BaseCodeImageLookupCaption,
		...
		return Terrasoft.BaseCodeImageLookup;
	});