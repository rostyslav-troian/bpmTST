define("SpecificationInProduct", ["terrasoft", "ext-base", "SpecificationInProductResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SpecificationInProduct", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SpecificationInProduct",
			singleton: true,
			uId: "5fa8a10e-372c-4d18-9709-04b9932d5509",
			name: "SpecificationInProduct",
			caption: resources.localizableStrings.SpecificationInProductCaption,
			...
			columns: {
				...
				Product: {
					uId: "f3edd8e0-8447-4a5a-9667-e83b42b5de3c",
					name: "Product",
		...
		return Terrasoft.SpecificationInProduct;
	});