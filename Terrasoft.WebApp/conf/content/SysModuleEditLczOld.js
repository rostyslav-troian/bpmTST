define("SysModuleEditLczOld", ["terrasoft", "ext-base", "SysModuleEditLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleEditLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleEditLczOld",
			singleton: true,
			uId: "6d4d8d3e-1673-483a-a8e0-73b19dbb7d9f",
			name: "SysModuleEditLczOld",
			caption: resources.localizableStrings.SysModuleEditLczOldCaption,
		...
		return Terrasoft.SysModuleEditLczOld;
	});