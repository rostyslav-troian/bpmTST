Terrasoft.configuration.Structures["VisaPage"] = {innerHierarchyStack: ["VisaPage"]};
define('VisaPageStructure', ['VisaPageResources'], function(resources) {return {schemaUId:'1743e579-7cf5-48cf-ba89-b490265be2da',schemaCaption: "Page - Approval", parentSchemaName: "", schemaName:'VisaPage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
