define("VwSysProcessFile", ["terrasoft", "ext-base", "VwSysProcessFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwSysProcessFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwSysProcessFile",
			singleton: true,
			uId: "45e3e868-0867-4e64-99fc-e03a63c57aa5",
			name: "VwSysProcessFile",
			caption: resources.localizableStrings.VwSysProcessFileCaption,
			...
			columns: {
				...
				VwSysProcess: {
					uId: "b89763dc-b135-47fc-9b6b-3224cfc5c09b",
					name: "VwSysProcess",
		...
		return Terrasoft.VwSysProcessFile;
	});