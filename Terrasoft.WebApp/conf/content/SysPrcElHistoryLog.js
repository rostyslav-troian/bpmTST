define("SysPrcElHistoryLog", ["terrasoft", "ext-base", "SysPrcElHistoryLogResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysPrcElHistoryLog", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysPrcElHistoryLog",
			singleton: true,
			uId: "eb76fc02-2956-4749-98f9-562581bceeb7",
			name: "SysPrcElHistoryLog",
			caption: resources.localizableStrings.SysPrcElHistoryLogCaption,
			...
			columns: {
				...
				SysProcess: {
					uId: "baa00dd8-03a7-4a3b-8818-9b2bc6c5e240",
					name: "SysProcess",
		...
		return Terrasoft.SysPrcElHistoryLog;
	});