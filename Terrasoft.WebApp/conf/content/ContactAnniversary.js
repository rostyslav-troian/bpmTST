define("ContactAnniversary", ["terrasoft", "ext-base", "ContactAnniversaryResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContactAnniversary", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContactAnniversary",
			singleton: true,
			uId: "fa36e9a5-c2fc-47b2-b5cb-2b58ef61d4e6",
			name: "ContactAnniversary",
			caption: resources.localizableStrings.ContactAnniversaryCaption,
			...
			columns: {
				...
				Contact: {
					uId: "e172fdfc-48ce-4a83-9e40-0c93bd26188f",
					name: "Contact",
		...
		return Terrasoft.ContactAnniversary;
	});