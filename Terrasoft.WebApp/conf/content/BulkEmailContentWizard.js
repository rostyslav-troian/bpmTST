Terrasoft.configuration.Structures["BulkEmailContentWizard"] = {innerHierarchyStack: ["BulkEmailContentWizard"]};
define('BulkEmailContentWizardStructure', ['BulkEmailContentWizardResources'], function(resources) {return {schemaUId:'091255bd-11da-4ac5-8256-9284cdfaa1f0',schemaCaption: "BulkEmailContentWizard", parentSchemaName: "", schemaName:'BulkEmailContentWizard',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define("BulkEmailContentWizard", ["BulkEmailContentWizardResources", "ContentBlockDesigner", "BulkEmailContentBuilder",
	"PreviewDefaultReplicaViewModel", "css!BulkEmailContentBuilderCSS", "css!ContentBlockCSS", "IssueViewer", "ImageView",
	"css!BulkEmailContentWizardCSS"], function(resources) {
	/** @enum
	 * Wizard actions */
		...
		methods: {
			...
			_getValidationConfig: function() {
				...
				return {
					...
					applyUnsubscribeAction: function(config, html) {
