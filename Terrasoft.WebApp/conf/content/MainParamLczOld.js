define("MainParamLczOld", ["terrasoft", "ext-base", "MainParamLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.MainParamLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.MainParamLczOld",
			singleton: true,
			uId: "24164caf-0471-406d-b77c-f47b1b4abc1b",
			name: "MainParamLczOld",
			caption: resources.localizableStrings.MainParamLczOldCaption,
		...
		return Terrasoft.MainParamLczOld;
	});