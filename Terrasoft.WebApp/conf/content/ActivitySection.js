Terrasoft.configuration.Structures["ActivitySection"] = {innerHierarchyStack: ["ActivitySectionNUI", "ActivitySection"]};
define('ActivitySectionNUIStructure', ['ActivitySectionNUIResources'], function(resources) {return {schemaUId:'ea6d7c8c-bd1c-4ecf-b595-d1a4ad979edf',schemaCaption: "Activities section (Old version)", parentSchemaName: "", schemaName:'ActivitySectionNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionStructure', ['ActivitySectionResources'], function(resources) {return {schemaUId:'5c54f4ec-fa7d-418d-9716-9eeea7a7e902',schemaCaption: "Activities section (Old version)", parentSchemaName: "ActivitySectionNUI", schemaName:'ActivitySection',parentSchemaUId:'ea6d7c8c-bd1c-4ecf-b595-d1a4ad979edf',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ActivitySectionNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("ActivitySectionNUI", ['ext-base', 'terrasoft', 'sandbox', 'Activity',
	"ActivitySectionNUIStructure", 'ActivitySectionNUIResources', 'ProcessModule',
