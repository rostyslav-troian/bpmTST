define("VwProcessLibFile", ["terrasoft", "ext-base", "VwProcessLibFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwProcessLibFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwProcessLibFile",
			singleton: true,
			uId: "46d85d4c-c6b5-4ed7-b600-a3b195d70acc",
			name: "VwProcessLibFile",
			caption: resources.localizableStrings.VwProcessLibFileCaption,
			...
			columns: {
				...
				VwProcessLib: {
					uId: "fbcd7bc3-cdd7-4522-8478-34010184d858",
					name: "VwProcessLib",
		...
		return Terrasoft.VwProcessLibFile;
	});