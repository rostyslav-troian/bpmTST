define("ExternalAccessFile", ["terrasoft", "ext-base", "ExternalAccessFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ExternalAccessFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ExternalAccessFile",
			singleton: true,
			uId: "b8e4b6ae-0200-4be2-823c-01ceee0e6b85",
			name: "ExternalAccessFile",
			caption: resources.localizableStrings.ExternalAccessFileCaption,
			...
			columns: {
				...
				ExternalAccess: {
					uId: "9517149f-8ff3-4f74-8e21-fc232694ee4f",
					name: "ExternalAccess",
		...
		return Terrasoft.ExternalAccessFile;
	});