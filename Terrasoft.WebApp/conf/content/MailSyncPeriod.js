define("MailSyncPeriod", ["terrasoft", "ext-base", "MailSyncPeriodResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.MailSyncPeriod", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.MailSyncPeriod",
			singleton: true,
			uId: "53c6a358-61c6-4679-a4c3-04d002f423e5",
			name: "MailSyncPeriod",
			...
			columns: {
				...
				Number: {
					uId: "35f1cb11-2561-4729-8ddb-51fde1dc9648",
					name: "Number",
				...
				Position: {
					uId: "eec3522f-31d8-473e-9469-baaf6cf58b33",
					name: "Position",
		...
		return Terrasoft.MailSyncPeriod;
	});