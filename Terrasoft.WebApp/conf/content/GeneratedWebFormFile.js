define("GeneratedWebFormFile", ["terrasoft", "ext-base", "GeneratedWebFormFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.GeneratedWebFormFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.GeneratedWebFormFile",
			singleton: true,
			uId: "7335ec89-db7b-42a5-822e-15a23cf99db9",
			name: "GeneratedWebFormFile",
			caption: resources.localizableStrings.GeneratedWebFormFileCaption,
			...
			columns: {
				...
				GeneratedWebForm: {
					uId: "11c3799a-2b95-444e-8511-1ed0c598bfc1",
		...
		return Terrasoft.GeneratedWebFormFile;
	});