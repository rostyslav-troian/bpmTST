Terrasoft.configuration.Structures["ContactInternalRatePageV2"] = {innerHierarchyStack: ["ContactInternalRatePageV2"], structureParent: "BasePageV2"};
define('ContactInternalRatePageV2Structure', ['ContactInternalRatePageV2Resources'], function(resources) {return {schemaUId:'f458cac4-e8f3-467b-aad7-369e13325787',schemaCaption: "ContactInternalRatePageV2", parentSchemaName: "BasePageV2", schemaName:'ContactInternalRatePageV2',parentSchemaUId:'d3cc497c-f286-4f13-99c1-751c468733c0',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define("ContactInternalRatePageV2", ["terrasoft", "BusinessRuleModule", "ext-base", "sandbox", "StorageUtilities"],
			...
			return {
				...
				methods: {
					...
					checkOnSave: function(datesChecked) {
						...
						var select = Ext.create("Terrasoft.EntitySchemaQuery", {rootSchemaName: "ContactInternalRate"});
