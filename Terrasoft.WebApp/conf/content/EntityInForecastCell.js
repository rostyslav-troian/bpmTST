define("EntityInForecastCell", ["terrasoft", "ext-base", "EntityInForecastCellResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.EntityInForecastCell", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.EntityInForecastCell",
			singleton: true,
			uId: "3a622ca4-e1ea-4273-8b41-c20129310fd7",
			name: "EntityInForecastCell",
			caption: resources.localizableStrings.EntityInForecastCellCaption,
		...
		return Terrasoft.EntityInForecastCell;
	});