Terrasoft.configuration.Structures["AccountSection"] = {innerHierarchyStack: ["AccountSection"]};
define('AccountSectionStructure', ['AccountSectionResources'], function(resources) {return {schemaUId:'1bf095c9-350c-4e5c-a035-74aaced5b508',schemaCaption: "Accounts section (old)", parentSchemaName: "", schemaName:'AccountSection',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
