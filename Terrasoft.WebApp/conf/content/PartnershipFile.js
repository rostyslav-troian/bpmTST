define("PartnershipFile", ["terrasoft", "ext-base", "PartnershipFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.PartnershipFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.PartnershipFile",
			singleton: true,
			uId: "142ad4d9-aa75-4800-9877-c80640a55ed9",
			name: "PartnershipFile",
			caption: resources.localizableStrings.PartnershipFileCaption,
			...
			columns: {
				...
				Partnership: {
					uId: "cf81a8ae-1644-461c-87ad-0b3c8add8a12",
					name: "Partnership",
		...
		return Terrasoft.PartnershipFile;
	});