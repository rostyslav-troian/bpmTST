Terrasoft.configuration.Structures["BulkEmailContentBuilder"] = {innerHierarchyStack: ["BulkEmailContentBuilder"], structureParent: "EmailContentBuilder"};
define('BulkEmailContentBuilderStructure', ['BulkEmailContentBuilderResources'], function(resources) {return {schemaUId:'adc54d56-59c8-4500-ac88-c8918efe10b2',schemaCaption: "Email content designer", parentSchemaName: "EmailContentBuilder", schemaName:'BulkEmailContentBuilder',parentSchemaUId:'ab75212f-7de6-4f93-a268-429bfab61422',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define("BulkEmailContentBuilder", ["BulkEmailTemplateHelper", "BulkEmailHyperlinkCorrector",
	...
	function(BulkEmailTemplateHelper, BulkEmailHyperlinkCorrector, BulkEmailContentBuilderEnumsModule,
		...
		return {
			...
			methods: {
				...
				getSendTestEmailContentSchemaCongfig: function() {
					var templateJson = this.getContentBuilderConfig();
					return {
						...
						bulkEmailId: this.get("RecordId"),
						replicaMask: this.$ActiveReplicaMask,
						replicaCount: this.calculateReplicasCount(templateJson)
					};
				},
