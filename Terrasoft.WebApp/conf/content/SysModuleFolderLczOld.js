define("SysModuleFolderLczOld", ["terrasoft", "ext-base", "SysModuleFolderLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleFolderLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleFolderLczOld",
			singleton: true,
			uId: "4a16bf19-1e23-4978-86d9-0f8a71dd0428",
			name: "SysModuleFolderLczOld",
			caption: resources.localizableStrings.SysModuleFolderLczOldCaption,
		...
		return Terrasoft.SysModuleFolderLczOld;
	});