define("SysModuleActionLczOld", ["terrasoft", "ext-base", "SysModuleActionLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleActionLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleActionLczOld",
			singleton: true,
			uId: "d999461b-4a77-4caf-9069-7bcb301d918c",
			name: "SysModuleActionLczOld",
			caption: resources.localizableStrings.SysModuleActionLczOldCaption,
			...
			columns: {
				...
				Record: {
					...
					isValueCloneable: true,
					isLookup: true,
					referenceSchemaName: "SysModuleAction",
					referenceSchema: {
		...
		return Terrasoft.SysModuleActionLczOld;
	});