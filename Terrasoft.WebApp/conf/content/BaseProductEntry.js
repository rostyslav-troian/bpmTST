define("BaseProductEntry", ["terrasoft", "ext-base", "BaseProductEntryResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseProductEntry", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseProductEntry",
			singleton: true,
			uId: "04802832-e447-4188-a324-f2d1ca6efcc4",
			name: "BaseProductEntry",
			caption: resources.localizableStrings.BaseProductEntryCaption,
		...
		return Terrasoft.BaseProductEntry;
	});