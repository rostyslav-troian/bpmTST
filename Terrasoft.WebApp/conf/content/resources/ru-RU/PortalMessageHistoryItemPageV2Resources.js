define("PortalMessageHistoryItemPageV2Resources", ["terrasoft"], function(Terrasoft) {
	...
	var localizableImages = {
		DefaultCreatedBy: {
			source: 3,
			params: {
				schemaName: "PortalMessageHistoryItemPageV2",
		...
		PortalChannelIcon: {
			...
			params: {
				schemaName: "PortalMessageHistoryItemPageV2",
				resourceItemName: "PortalChannelIcon",
				hash: "b0db8dac127e409a4dfaece1eced102f",
				resourceItemExtension: ".svg"
			}
		},
		HideOnPortal: {
