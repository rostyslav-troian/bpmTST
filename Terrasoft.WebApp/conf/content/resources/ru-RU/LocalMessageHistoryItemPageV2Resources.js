define("LocalMessageHistoryItemPageV2Resources", ["terrasoft"], function(Terrasoft) {
	...
	var localizableImages = {
		DefaultCreatedBy: {
			source: 3,
			params: {
				schemaName: "LocalMessageHistoryItemPageV2",
		...
		LocalMessageImage: {
			...
			params: {
				schemaName: "LocalMessageHistoryItemPageV2",
				resourceItemName: "LocalMessageImage",
				hash: "f1a336332216952431cced2f5902f0af",
				resourceItemExtension: ".png"
			}
		},
		...
		LocalChannelIcon: {
			...
			params: {
				schemaName: "LocalMessageHistoryItemPageV2",
				resourceItemName: "LocalChannelIcon",
				hash: "89f3f8975a590d837318e7782473af04",
				resourceItemExtension: ".svg"
			}
		},
		FilesIcon: {
