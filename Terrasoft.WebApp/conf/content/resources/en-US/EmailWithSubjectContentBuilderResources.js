define("EmailWithSubjectContentBuilderResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		SubjectLabelCaption: "Email subject",
		FillLabelCaption: "Fill"
	};
	var localizableImages = {
		DefaultBlockImage: {
			source: 3,
			params: {
				schemaName: "EmailWithSubjectContentBuilder",
