define("LanguageSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		DeleteConfirmationMessage: "Are you sure that you want to delete the selected record?",
		NewLanguage: "New language",
		SectionCaption: "Languages",
		PageCaption: "Language",
		NavigateToTranslationCaption: "Go to the translation",
		ExportCaption: "Export",
		ImportCaption: "Import",
		PrimaryCultureDeleteMessage: "Cannot delete default language.",
		DefaultExceptionMessage: "You cannot delete a language that is used for translation. You can disable a localization language by clearing the \u0022Enabled\u0022 checkbox on the language page."
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "LanguageSection",
