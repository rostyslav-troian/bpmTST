define("PortalPartnershipSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		EmptyInfoDescription: "It appears that you do not have any active partnerships right now. Please contact your partner relations manager.",
		Caption: "Portal Partnership"
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "PortalPartnershipSection",
