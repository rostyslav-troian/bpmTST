define("ProceedToHandOffInformationPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		NewTab1Caption: "New tab",
		NewTab1Group1Caption: "New field group",
	...
	var localizableImages = {
		BackButtonImage: {
			source: 3,
			params: {
				schemaName: "ProceedToHandOffInformationPage",
