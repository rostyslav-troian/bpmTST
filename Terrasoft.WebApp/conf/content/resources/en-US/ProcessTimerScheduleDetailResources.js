define("ProcessTimerScheduleDetailResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		EmptyGrid: "No data",
		TimerState0: "Scheduled",
		TimerState1: "Paused",
		TimerState2: "Completed",
		TimerState3: "Error",
		TimerState4: "Executing",
		TimerState5: "Not exists",
		ColumnPreviousFireTime: "Previous fire time",
		ColumnNextFireTime: "Next fire time",
		ColumnState: "Trigger state",
		ColumnCaption: "Element name"
	};
