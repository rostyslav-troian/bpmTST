define("SysMobileWorkplaceSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		AddRecordButtonCaption: "New workplace",
		HeaderCaption: "Mobile application wizard",
		DeleteDefaultWorkplaceMessage: "Unable to delete the \u0022Default workplace\u0022: system must contain at least one workplace",
		NameColumnCaption: "Workplace",
