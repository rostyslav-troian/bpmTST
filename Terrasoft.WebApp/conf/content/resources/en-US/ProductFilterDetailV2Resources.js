define("ProductFilterDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		AddButtonCaption: "\u002B",
		Caption: "Filters",
		AddSpecificationFilterButtonCaption: "Filter by feature",
		AddColumnFilterButtonCaption: "Filter by product field",
		AddPriceFilterButtonCaption: "Filter by price",
		ProductColumnFilterExists: "Filter by this field has been already added",
		CantCheckProductColumnFilterError: "Unable to verify if the added value is unique. The selected filter will not be added"
	};
