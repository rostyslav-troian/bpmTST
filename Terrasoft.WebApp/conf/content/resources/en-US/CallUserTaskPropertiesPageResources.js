define("CallUserTaskPropertiesPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		RecommendationCaption: "What is the call subject?"
	};
	var localizableImages = {
		TaskParameters: {
			source: 3,
			params: {
				schemaName: "CallUserTaskPropertiesPage",
