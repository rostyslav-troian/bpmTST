define("VwDcmLibSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		DisableCase: "Deactivate case",
		EnableCase: "Activate case",
		DisableLastActiveDcmSchemaMessage: "When you deactivate last active case, progress bar in section page will be hidden",
		StageColumnIsNotSupportedMessage: "Case setting \u0022Which column the stages are built by\u0022 is not \u0441orresponds to section setting"
	};
