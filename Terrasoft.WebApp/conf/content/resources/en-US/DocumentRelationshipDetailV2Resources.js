define("DocumentRelationshipDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		Caption: "Related documents",
		LinkWithExistingCaption: "Connect to existing",
		DeleteLinkWithDocumentsCaption: "Delete connections with selected",
		AddedLinksCountMessage: "{0} out of {1} documents added"
	};
