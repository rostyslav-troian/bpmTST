define("ProjectStructureDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		Caption: "Structure",
		AddChildItemCaption: "New subordinate project task",
		AddRootItemCaption: "Add root project task",
		ChangePositionUpButtonCaption: "Up",
		ChangePositionDownButtonCaption: "Down",
		ChangeProjectDatesButtonCaption: "Edit project task timeframe"
	};
	var localizableImages = {
		...
		DownImage: {
			...
			params: {
				schemaName: "ProjectStructureDetailV2",
				resourceItemName: "DownImage",
				hash: "45052cca9a07b63f77708528eb482251",
				resourceItemExtension: ".png"
			}
		},
		ProcessButtonImage: {
