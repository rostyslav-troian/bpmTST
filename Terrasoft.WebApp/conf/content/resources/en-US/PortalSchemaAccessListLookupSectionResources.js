define("PortalSchemaAccessListLookupSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		AccessEntitySchemaCaption: "Schema"
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "PortalSchemaAccessListLookupSection",
