define("CampaignSectionV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		OpenCampaignLogCaption: "Campaign log",
		RemoveActiveCampaignValidationMessage: "Only campaign with status \u0022Planned\u0022 can be deleted",
		RemoveMultipleActiveCampaignsValidationMessage: "Only campaign with status \u0022Planned\u0022 can be deleted"
	};
