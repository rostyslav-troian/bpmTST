define("CampaignPlannerSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		CampaignsViewHeader: "Marketing plans",
		MarketingActivitiesViewHeader: "Marketing activities",
		PrintMenuItemCaption: "Print",
		ViewButtonWeekScaleCaption: "Scale WEEK",
		ViewButtonMonthScaleCaption: "Scale MONTH",
		ViewButtonQuarterScaleCaption: "Scale QUARTER",
		MarketingCampaignsAnalyticsDataViewCaption: "Dashboards"
	};
	var localizableImages = {
		CalendarViewIcon: {
			source: 3,
			params: {
				schemaName: "CampaignPlannerSection",
				resourceItemName: "CalendarViewIcon",
				hash: "549d7c018b302c8aacbe59b67abd7f5b",
		...
		ActivitiesViewIcon: {
			...
			params: {
				schemaName: "CampaignPlannerSection",
				resourceItemName: "ActivitiesViewIcon",
				hash: "4ad1e9ae377f2c55a0c9a8d8e8e3e2d7",
				resourceItemExtension: ".svg"
			}
		},
		ToggleCalendarIcon: {
			...
			params: {
				schemaName: "CampaignPlannerSection",
				resourceItemName: "ToggleCalendarIcon",
				hash: "e2c485b6004a04b848d65661564f173c",
				resourceItemExtension: ".svg"
			}
		},
		GridDataViewIcon: {
