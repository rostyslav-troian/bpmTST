define("MLModelSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ExecuteJobActionCaption: "Execute model training job",
		ExecuteJobActionMessage: "The job for models training has been successfully planned",
		OpenMLProblemTypeLookup: "Open ML problem types",
		MLProblemTypeLookupCaption: "ML problem types"
	};
