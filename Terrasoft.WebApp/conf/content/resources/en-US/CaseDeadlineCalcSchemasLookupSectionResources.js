define("CaseDeadlineCalcSchemasLookupSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		RemoveDefaultStrategyMessage: "Impossible to delete Default calculation schema"
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "CaseDeadlineCalcSchemasLookupSection",
