define("BaseActivityUserTaskPropertiesPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ProcessLookupPageCaption: "Select connections"
	};
	var localizableImages = {
		TaskParameters: {
			source: 3,
			params: {
				schemaName: "BaseActivityUserTaskPropertiesPage",
