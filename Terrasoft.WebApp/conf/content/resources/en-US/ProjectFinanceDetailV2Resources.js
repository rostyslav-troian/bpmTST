define("ProjectFinanceDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		SignificativeCaption: "Indicator",
		PlanCaption: "Expected",
		FactCaption: "Actual",
		DeviationCaption: "Deviation",
		DeviationProcCaption: "Deviation %",
		IncomeCaption: "Revenue",
		ExternalCostCaption: "Total outflow",
		ExpenseCaption: "Total cost",
		InternalCostCaption: "Prime cost",
		MarginCaption: "Margin",
		MarginPercCaption: "Margin, %",
		ReCalcButtonCaption: "Calculate",
		Caption: "Financial indicators",
		CalculateHint: ""
	};
	var localizableImages = {
		Calculate: {
			...
			params: {
				...
				resourceItemName: "Calculate",
				hash: "125c01e4a76425bd3a97739e1a95e4a8",
