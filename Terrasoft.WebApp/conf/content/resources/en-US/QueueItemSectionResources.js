define("QueueItemSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		GridDataViewCaption: "Queues",
		AnalyticsDataViewCaption: "Queues",
		EmptyInfoTitle: "There are no items in the queues.",
		EmptyInfoDescription: "Add a new queue with items to make it look better.",
		QueuesSettingsDataViewCaption: "Queues settings",
		OperatorFixedFilterCaption: "Operator",
		QueueFixedFilterCaption: "Queue",
		AddOperatorFixedFilterCaption: "Add operator",
		AddQueueFixedFilterCaption: "Add queue",
		ShowProcessedCheckboxCaption: "Show processed",
		AgentViewCheckboxCaption: "Agent view",
		ChangeStatusMenuItemCaption: "Change status",
		QueueItemsUpdatedMessage: "Queue items updated: {0}",
		AssignOperatorActionCaption: "Assign operator",
		ClearOperatorActionCaption: "Clear operator",
