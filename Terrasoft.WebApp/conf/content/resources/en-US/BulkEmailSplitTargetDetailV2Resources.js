define("BulkEmailSplitTargetDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		AudienceEditingDisabledMessage: "Test started. Audience cannot be edited.",
		BulkEmailDetailIsEmptyMessage: "Unable to add the audience. Please make sure that on the \u0022Bulk emails\u0022 you specified at least two bulk emails to be used for split test and try again.",
		InvalidRecipientPercentMessage: "In the \u0022% recipients\u0022 field, specify a value in the range of 0.1 - 100"
	};
