define("MainHeaderSchemaResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		DefaultPageHeaderCaption: "New record",
		...
		DevButtonCaption: "Configuration",
		CompanyProfileCaption: "Organization",
		JSUnitTestsButtonCaption: "JS Tests",
		OpenDebugUnitTestPageCaption: "Open debug page",
		OpenCoverUnitTestPageCaption: "Open coverage page",
		ExtendedUserProfileCaption: "Settings",
		SspProfileCaption: "Profile"
	};
	var localizableImages = {
		...
		CompanyProfileIcon: {
			...
			params: {
				...
				hash: "29343db3ee97c7ae993ac2b35f7696d9",
				resourceItemExtension: ".svg"
			}
		},
		JSUnitTestsButtonIcon: {
			source: 3,
			params: {
				schemaName: "MainHeaderSchema",
				resourceItemName: "JSUnitTestsButtonIcon",
				hash: "371149e6093347c344d30d0d5f9b22b7",
				resourceItemExtension: ".svg"
			}
		},
		UserSettingsIcon: {
			...
			params: {
				...
				hash: "2fe81015a1b597e0f790b189adf84ab5",
				resourceItemExtension: ".svg"
			}
		},
		SspProfileIcon: {
