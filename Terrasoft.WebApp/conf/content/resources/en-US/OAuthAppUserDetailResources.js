define("OAuthAppUserDetailResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		RemoveCallbackFailed: "Error loading OAuth remove user service",
		LoginActionCaption: "Log in",
		UserAlreadyAuthorized: "Your account has already been added. To add another account, please delete your current one."
	};
