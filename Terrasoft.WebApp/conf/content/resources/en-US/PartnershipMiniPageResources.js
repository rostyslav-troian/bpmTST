define("PartnershipMiniPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ExistingActivePartnershipMessage: "Active partnership has already been added for the selected account"
	};
	var localizableImages = {
		AddButtonImage: {
			source: 3,
			params: {
				schemaName: "PartnershipMiniPage",
