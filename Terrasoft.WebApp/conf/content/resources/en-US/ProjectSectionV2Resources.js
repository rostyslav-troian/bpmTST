define("ProjectSectionV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		CalculatePlanManpowerCaption: "Recalculate estimated working time by subordinate items",
		CountManpowerCaption: "Calculate actual working time",
		ManpowerGroupCaption: "Working time",
		ChangeDates: "Change item dates",
		CalculateFinanceCaption: "Calculate financial indicators",
		PeriodFilterCaption: "Period",
		OwnerFilterCaption: "Owner",
		CopyProjectStructure: "Copy the project include the subordinate work?"
	};
