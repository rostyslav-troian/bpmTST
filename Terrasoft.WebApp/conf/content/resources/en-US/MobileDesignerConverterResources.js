define("MobileDesignerConverterResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ConvertSettingsButtonCaption: "Convert the mobile application designer settings",
		DefaultWorkplaceCaption: "Default workplace",
		CompletionMessage: "Conversion complete. The change will take effect after you manually open schemas from your package and re-save the ones ending with \u0027Settings\u0027.",
		OldManifestWasNotFound: "The old format manifest was not found in the specified package"
	};
