define("SiteEventAttributeSectionV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		HeaderCaption: "Attributes settings",
		ShortHeaderCaption: "Attributes"
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "SiteEventAttributeSectionV2",
