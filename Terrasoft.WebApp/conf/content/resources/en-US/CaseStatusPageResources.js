define("CaseStatusPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		IsResolvedCaption: "Is resolved",
		IsPausedCaption: "Is paused",
		ButtonCaption: "Button caption",
		ClosureCodeCaption: "Reason for closing",
		IsCloseOnSaveCaption: "Is close on save"
	};
	var localizableImages = {
		TagButtonIcon: {
			source: 3,
			params: {
				schemaName: "CaseStatusPage",
