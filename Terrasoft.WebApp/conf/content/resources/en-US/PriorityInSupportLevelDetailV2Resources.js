define("PriorityInSupportLevelDetailV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		Caption: "Priority in Support level",
		CasePriorityIsExist: "The Current value is already exists",
		CasePriorityIsNotFilling: "The \u0022Case priority\u0022 can not be empty",
		ResponseOrReactionFillingFalse: "Please fill in response time or resolution time"
	};
