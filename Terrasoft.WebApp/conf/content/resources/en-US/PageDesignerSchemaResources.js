define("PageDesignerSchemaResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ExistingFieldsControlGroupCaption: "Add existing field",
		NewFieldsControlGroupCaption: "Add new field",
		WidgetInNewSectionWarning: "Please save your new page before adding a widget",
		NewElementButtonCaption: "Button",
		ButtonsParameterCaption: "Buttons",
		NoCaptionButtonCaption: "(no caption)",
