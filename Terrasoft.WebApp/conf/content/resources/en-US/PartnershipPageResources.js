define("PartnershipPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		PageContainsUnsavedChanges: "This page contains unsaved changes. Do you still wish to leave the page?",
		CurrentPointCaption: "Current point",
		...
		FinanceTabCaption: "Finances",
		GeneralInfoTabCaption: "General info",
		CertifiedEmployeesCaption: "Certified employees",
		TotalSalesCaption: "Total sales",
		MarginCaption: "Margin, percent",
		HistoryTabCaption: "History",
		InvoiceTabCaption: "Invoices",
		CanCustomizeWarning: "Define {0} attribute instead of overriding function {1} to empty",
		IsAccountTerritoryFilledOut: "To activate partnership fill in Territory in account",
		TabVisaCaption: "Approvals",
		Tab9c516372TabLabel: "Attachments",
		OpportunityAndLeadTabCaption: "Opportunities and Leads",
		Tabd4168968TabLabelTabCaption: "Partner Projects"
	};
	var localizableImages = {
		TagButtonIcon: {
			source: 3,
			params: {
				schemaName: "PartnershipPage",
