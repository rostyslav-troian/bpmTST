define("SAMLFieldNameConverterSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		HeaderCaption: "SAML field name converters to contact field name"
	};
	var localizableImages = {
		GridDataViewIcon: {
			source: 3,
			params: {
				schemaName: "SAMLFieldNameConverterSection",
