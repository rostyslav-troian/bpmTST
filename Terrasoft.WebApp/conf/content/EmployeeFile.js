define("EmployeeFile", ["terrasoft", "ext-base", "EmployeeFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.EmployeeFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.EmployeeFile",
			singleton: true,
			uId: "10f8d911-7359-470e-9ff1-321d9211efab",
			name: "EmployeeFile",
			caption: resources.localizableStrings.EmployeeFileCaption,
			...
			columns: {
				...
				Employee: {
					uId: "e792ec57-91cc-418c-bebd-e4c53d3735b2",
					name: "Employee",
