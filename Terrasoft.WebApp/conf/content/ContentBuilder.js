Terrasoft.configuration.Structures["ContentBuilder"] = {innerHierarchyStack: ["ContentBuilderContentBuilder", "ContentBuilder"]};
define('ContentBuilderContentBuilderStructure', ['ContentBuilderContentBuilderResources'], function(resources) {return {schemaUId:'ac58e9b9-1a9b-43d2-afae-16317c8c0adb',schemaCaption: "ContentBuilder", parentSchemaName: "", schemaName:'ContentBuilderContentBuilder',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ContentBuilderStructure', ['ContentBuilderResources'], function(resources) {return {schemaUId:'20d6563e-d2e6-4606-a730-09003a4974fb',schemaCaption: "ContentBuilder", parentSchemaName: "ContentBuilderContentBuilder", schemaName:'ContentBuilder',parentSchemaUId:'ac58e9b9-1a9b-43d2-afae-16317c8c0adb',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ContentBuilderContentBuilder",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ContentBuilderContentBuilderResources', ['terrasoft'], function(Terrasoft) {
...
define("ContentBuilderContentBuilder", [
	"ModalBox",
	"MacrosModule",
	...
	return {
		...
		methods: {
			...
			_unselectCurrentElement: function(selectedItemId) {
				...
				if (currentSelectedElement) {
					...
					if ((itemType === "block" || itemType === "mjblock")
			...
			_canPublishConfig: function() {
				return this.$SelectedContentItem && this.$RightPanelVisible;
			},
			...
			_extendWithBreadcrumbs: function (config) {
				...
				for(var i = 0; i < 3; i++) {
					...
					currentItem = this._getParentItem(currentItem, this, ["blockgroup", "mjgroup"]) || this;
				}
			},
			...
			/**
			 * Handler of Escape button keyUp event.
			 * @protected
			 */
			onEscapeKeyUp: function() {
				...
				var parent = this._getParentItem(this.$SelectedContentItem, this, ["mjgroup"]);
			...
			getContentBuilderState: function(config) {
				...
				if (!configState) {
					return featureState === Terrasoft.ContentBuilderParams.mjmlFeature.ON
						? Terrasoft.ContentBuilderState.MJML
						: Terrasoft.ContentBuilderState.GRID;
				}
			...
			subscribeMessages: function() {
				...
				this.sandbox.subscribe("GetContentItemConfig", this.publishSelectedContentItemConfig, this,
					["ContentPanelLoader"]);
			...
			/**
			 * Publishes properties of active content item.
			 * @protected
			 */
			publishSelectedContentItemConfig: function() {
			...
			onSelectedContentItemChange: function() {
				if (this._canPublishConfig()) {
					this.publishSelectedContentItemConfig();
				}
			...
			openPreviewModule: function() {
				if (Terrasoft.Features.getIsEnabled("ContentBlockDesigner")) {
					this.$IsPreviewVisible = true;
				} else {
					var html = this.getPreviewHtml();
					var previewWindow = window.open("", "printwin"); // eslint-disable-line spellcheck/spell-checker
			...
			hideContentItemPanel: function() {
				...
				this.sandbox.unloadModule("ContentPanelModule");
			},
			...
			/**
			 * Handler on migrate button click action.
			 * @protected
			 */
			onMigrateClick: function() {
				// TODO: #MK-7474
			},
		...
		diff: [
			...
			},
			{
				...
				"values": {
					"itemType": Terrasoft.ViewItemType.BUTTON,
					"caption": "$Resources.Strings.MigrateButtonCaption",
					"classes": {"textClass": "actions-button-margin-right"},
					"click": "$onMigrateClick",
					"style": Terrasoft.controls.ButtonEnums.style.RED,
					"visible": "$isMigrateState",
					// TODO: #MK-7474
					"enabled": false
				}
			},
