define("VwSysEntitySchemaInWorkspace", ["terrasoft", "ext-base", "VwSysEntitySchemaInWorkspaceResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwSysEntitySchemaInWorkspace", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwSysEntitySchemaInWorkspace",
			singleton: true,
			uId: "2e155463-3ff1-4ccf-8584-4ec8d7233111",
			name: "VwSysEntitySchemaInWorkspace",
			caption: resources.localizableStrings.VwSysEntitySchemaInWorkspaceCaption,
			...
			columns: {
				...
				IsVirtual: {
					uId: "1f63f50c-e413-4992-9baf-7de2310a1149",
					name: "IsVirtual",
		...
		return Terrasoft.VwSysEntitySchemaInWorkspace;
	});