define("EventFile", ["terrasoft", "ext-base", "EventFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.EventFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.EventFile",
			singleton: true,
			uId: "89e6461e-0cad-4500-a9cd-fa879ce8ae1c",
			name: "EventFile",
			caption: resources.localizableStrings.EventFileCaption,
			...
			columns: {
				...
				Event: {
					uId: "3e62b2d0-2d9d-4d94-ab20-1d24c7ebbbdf",
					name: "Event",
