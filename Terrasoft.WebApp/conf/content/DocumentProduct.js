define("DocumentProduct", ["terrasoft", "ext-base", "DocumentProductResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.DocumentProduct", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.DocumentProduct",
			singleton: true,
			uId: "5bab82ce-a828-4259-8ed9-5416ea3a0113",
			name: "DocumentProduct",
			caption: resources.localizableStrings.DocumentProductCaption,
		...
		return Terrasoft.DocumentProduct;
	});