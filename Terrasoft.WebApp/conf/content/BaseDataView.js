Terrasoft.configuration.Structures["BaseDataView"] = {innerHierarchyStack: ["BaseDataViewNUI", "BaseDataViewDevExpress", "BaseDataViewDeduplication", "BaseDataViewESN", "BaseDataView"]};
define('BaseDataViewNUIStructure', ['BaseDataViewNUIResources'], function(resources) {return {schemaUId:'22e2cf10-98b4-4c3c-bc28-346238e15c21',schemaCaption: "Base data view", parentSchemaName: "", schemaName:'BaseDataViewNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewDevExpressStructure', ['BaseDataViewDevExpressResources'], function(resources) {return {schemaUId:'947b6325-10a3-412a-a3a5-25cc09b22544',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewNUI", schemaName:'BaseDataViewDevExpress',parentSchemaUId:'22e2cf10-98b4-4c3c-bc28-346238e15c21',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewDeduplicationStructure', ['BaseDataViewDeduplicationResources'], function(resources) {return {schemaUId:'75ca5755-d86b-4daa-8a57-3bc400658357',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewDevExpress", schemaName:'BaseDataViewDeduplication',parentSchemaUId:'947b6325-10a3-412a-a3a5-25cc09b22544',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewDevExpress",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewESNStructure', ['BaseDataViewESNResources'], function(resources) {return {schemaUId:'39e54205-fbb4-4945-a2c3-50768a0625a1',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewDeduplication", schemaName:'BaseDataViewESN',parentSchemaUId:'75ca5755-d86b-4daa-8a57-3bc400658357',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewDeduplication",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewStructure', ['BaseDataViewResources'], function(resources) {return {schemaUId:'6f8acb3b-5322-4111-abe6-dc16d62d334c',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewESN", schemaName:'BaseDataView',parentSchemaUId:'39e54205-fbb4-4945-a2c3-50768a0625a1',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewESN",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("BaseDataViewNUI", ["terrasoft", "ConfigurationEnums", "ConfigurationConstants", "RightUtilities",
	...
	"FixedSectionGridCaptionsPlugin", "TagUtilitiesV2", "GridUtilitiesV2", "DataUtilities",
	...
	"WizardUtilities", "ContextHelpMixin", "CheckModuleDestroyMixin", "DcmMixin",
	"EmailLinksMixin", "FileImportMixin", "css!BaseSectionV2CSS"
		...
		changeLogUtilities, FixedSectionGridCaptionsPlugin) {
	return {
		messages: {
			/**
		...
		methods: {
			...
			getCardHistoryStateConfig: function(config) {
				...
				if (this.getIsSectionVisible()) {
					...
					hash = Terrasoft.combinePath("CardModuleV2", schemaName, operation, primaryColumnValue);
				}
				return {
					stateObj: Terrasoft.deepClone(currentHistoryState.state),
					silent: true,
					hash: hash
				};
			},
			...
			editRecord: function(primaryColumnValue) {
				...
				const activeRow = this.getActiveRow() || this.getGridDataRow(primaryColumnValue);
			...
			onRender: function() {
				...
				this.switchActiveRowActions();
				const isDataReloaded = this.get("GridSettingsChanged");
				if (isDataReloaded === true) {
					this.reloadGridData();
				}
				if (this.get("Restored")) {
					this.reloadGridColumnsConfig(true);
					this._setSettingsCard(isDataReloaded);
			...
			initAddRecordButtonParameters: function() {
				...
				if (editPagesCount === 1) {
					...
					const sectionEntity = Terrasoft.configuration.EntityStructure[entitySchemaName];
			...
			initPrintButtonsMenu: function(callback, scope) {
				...
				this.mixins.PrintReportUtilities.initCurrentModuleReports.call(this);
			...
			createScrollTopBtn: function() {
				...
				Ext.EventManager.addListener(Ext.get(this.getScrollContainerId()), "scroll", function() {
					const historyStateInfo = scope.getHistoryStateInfo();
					if (historyStateInfo.workAreaMode === ConfigurationEnums.WorkAreaMode.COMBINED) {
						const top = this.scrollTop;
						scope.set("ScrollTop", top);
						const scrollContainer = Ext.get(scope.getScrollContainerId());
						if (scrollContainer) {
							scope.updateScrollTopBtnPosition(scope, scrollContainer.getHeight() - 35);
						}
					}
				});
			},
...
define('BaseDataViewDevExpressResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseDataViewDevExpress", ["DevExpressPrintReportUtilities"], function() {
	return {
		mixins: {
...
define('BaseDataViewDeduplicationResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseDataViewDeduplication", ["RightUtilities", "DuplicatesSearchUtilitiesV2", "DuplicatesMergeHelper", "SectionMergeHelper"],
		...
		return {
			...
			methods: {
				...
				isMergeVisible: function() {
					return Boolean(this.$CanMergeDuplicates) &&
						this.mixins.SectionMergeHelper.isMergeVisible.apply(this, arguments);
				},
				...
				/**
				 * @inheritdoc Terrasoft.AccountSectionV2#openDuplicatesModule
				 * @overridden
				 */
				openDuplicatesModule: function() {
					const hash = Ext.String.format("CardModuleV2/DuplicatesPageV2/{0}", this.entitySchemaName);
...
define('BaseDataViewESNResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseDataViewESN", ["ServiceHelper", "EsnSubscriptionMixin"], function(ServiceHelper) {
	return {
		messages: {
			/**
