define("ContractVisa", ["terrasoft", "ext-base", "ContractVisaResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContractVisa", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContractVisa",
			singleton: true,
			uId: "e2edcaf0-4bec-418f-9c13-b1e07e7244c5",
			name: "ContractVisa",
			caption: resources.localizableStrings.ContractVisaCaption,
			...
			columns: {
				...
				Contract: {
					uId: "fe0dfac8-c69e-4744-b030-d6998935c904",
					name: "Contract",
