define("BulkEmailFile", ["terrasoft", "ext-base", "BulkEmailFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BulkEmailFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BulkEmailFile",
			singleton: true,
			uId: "8449efd0-9a51-47fb-995a-7695efafaefd",
			name: "BulkEmailFile",
			caption: resources.localizableStrings.BulkEmailFileCaption,
			...
			columns: {
				...
				BulkEmail: {
					uId: "f0889160-a214-4012-979f-86fba6838077",
					name: "BulkEmail",
		...
		return Terrasoft.BulkEmailFile;
	});