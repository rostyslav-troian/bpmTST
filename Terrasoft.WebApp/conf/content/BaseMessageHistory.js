define("BaseMessageHistory", ["terrasoft", "ext-base", "BaseMessageHistoryResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseMessageHistory", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseMessageHistory",
			singleton: true,
			uId: "a8f74749-bbc1-47a6-84b6-10e974356e91",
			name: "BaseMessageHistory",
			caption: resources.localizableStrings.BaseMessageHistoryCaption,
		...
		return Terrasoft.BaseMessageHistory;
	});