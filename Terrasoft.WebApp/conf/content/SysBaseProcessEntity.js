define("SysBaseProcessEntity", ["terrasoft", "ext-base", "SysBaseProcessEntityResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysBaseProcessEntity", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysBaseProcessEntity",
			singleton: true,
			uId: "60a89d9d-9ede-4d78-97b9-5e20373db518",
			name: "SysBaseProcessEntity",
			caption: resources.localizableStrings.SysBaseProcessEntityCaption,
		...
		return Terrasoft.SysBaseProcessEntity;
	});