Terrasoft.configuration.Structures["DynamicContentMjBlockViewModel"] = {innerHierarchyStack: ["DynamicContentMjBlockViewModel"]};
define("DynamicContentMjBlockViewModel", ["DynamicContentMjBlockViewModelResources", "ContentMjBlockViewModel",
	...
	function(resources) {
		...
		/**
		 * @class Terrasoft.controls.DynamicContentMjBlockViewModel
		 */
		Ext.define("Terrasoft.DynamicContentMjBlockViewModel", {
			 ...
			 * @override
			 */
			className: "Terrasoft.DynamicContentMjBlock",
		...
		return Terrasoft.DynamicContentMjBlockViewModel;
	}
);
