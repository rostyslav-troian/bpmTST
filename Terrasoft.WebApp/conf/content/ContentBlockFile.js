define("ContentBlockFile", ["terrasoft", "ext-base", "ContentBlockFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContentBlockFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContentBlockFile",
			singleton: true,
			uId: "a1a57c69-870e-4e7f-bd49-f7887574914f",
			name: "ContentBlockFile",
			caption: resources.localizableStrings.ContentBlockFileCaption,
			...
			columns: {
				...
				ContentBlock: {
					uId: "f9fa0a26-9dfb-4d20-a406-b3b7631ba41f",
					name: "ContentBlock",
					caption: resources.localizableStrings.ContentBlockCaption,
					dataValueType: Terrasoft.DataValueType.LOOKUP,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
		...
		return Terrasoft.ContentBlockFile;
	});