Terrasoft.configuration.Structures["InvoiceProductPage"] = {innerHierarchyStack: ["InvoiceProductPage"]};
define('InvoiceProductPageStructure', ['InvoiceProductPageResources'], function(resources) {return {schemaUId:'177cfcf5-6d9c-460f-8e62-77460f8d9fee',schemaCaption: "Edit page - Product in invoice", parentSchemaName: "", schemaName:'InvoiceProductPage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define("InvoiceProductPage", ['ext-base', 'terrasoft', 'sandbox',
	'InvoiceProduct', "InvoiceProductPageStructure", 'InvoiceProductPageResources',
	'BusinessRuleModule', 'MoneyModule'],
	function(Ext, Terrasoft, sandbox, InvoiceProduct, structure,
			resources, BusinessRuleModule, MoneyModule) {
		structure.userCode = function() {
			this.entitySchema = InvoiceProduct;
			this.name = 'InvoiceProductCardViewModel';
					...
					columns: [
						{
							...
							columnPath: 'Invoice',
							viewVisible: true,
							labelClass: 'invoice-invoicename'
						}
					]
				};
			};
