Terrasoft.configuration.Structures["OktellModule"] = {innerHierarchyStack: ["OktellModule"]};
// jscs:disable
/* jshint ignore:start */
/*ignore jslint start*/
...
//				}
			...
			checkUserRedirect: function(callback) {
				...
				sendOktell("getredirectrules",{}, function(data) {
					if ( data.result ) {
						var rule;
						if ( data.redirectrules && data.redirectrules.length > 0 ) { // #### #### #######
