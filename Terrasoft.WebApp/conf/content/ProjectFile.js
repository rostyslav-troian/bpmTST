define("ProjectFile", ["terrasoft", "ext-base", "ProjectFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ProjectFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ProjectFile",
			singleton: true,
			uId: "f14221ba-b009-4e40-bc36-de79c936856e",
			name: "ProjectFile",
			caption: resources.localizableStrings.ProjectFileCaption,
			...
			columns: {
				...
				Project: {
					uId: "71363b65-94c0-465a-a20e-ffff3aade992",
					name: "Project",
