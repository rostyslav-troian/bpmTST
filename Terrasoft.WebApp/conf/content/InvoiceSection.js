...
define('InvoiceSectionStructure', ['InvoiceSectionResources'], function(resources) {return {schemaUId:'2a741c21-e266-4a68-95bb-411f34adc6d8',schemaCaption: "Section - Invoices", parentSchemaName: "", schemaName:'InvoiceSection',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
