Terrasoft.configuration.Structures["StructureExplorerUtilities"] = {innerHierarchyStack: ["StructureExplorerUtilities"]};
define("StructureExplorerUtilities", ["ModalBox", "MaskHelper"], function(modalBox, MaskHelper) {
