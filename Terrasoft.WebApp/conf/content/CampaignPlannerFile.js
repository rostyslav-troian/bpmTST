define("CampaignPlannerFile", ["terrasoft", "ext-base", "CampaignPlannerFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.CampaignPlannerFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.CampaignPlannerFile",
			singleton: true,
			uId: "8367bc89-7c3c-4dad-b104-d4f16c806d33",
			name: "CampaignPlannerFile",
			caption: resources.localizableStrings.CampaignPlannerFileCaption,
			...
			columns: {
				...
				CampaignPlanner: {
					uId: "f4f17a08-ea9d-4678-8180-efe99467cefe",
		...
		return Terrasoft.CampaignPlannerFile;
	});