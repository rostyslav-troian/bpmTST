define("ServiceItemFile", ["terrasoft", "ext-base", "ServiceItemFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ServiceItemFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ServiceItemFile",
			singleton: true,
			uId: "d8ef8005-3bbd-4907-9e7a-4aef9b915fd6",
			name: "ServiceItemFile",
			caption: resources.localizableStrings.ServiceItemFileCaption,
			...
			columns: {
				...
				ServiceItem: {
					uId: "fffadabb-50fa-481f-a739-a5d1bd523599",
					name: "ServiceItem",
		...
		return Terrasoft.ServiceItemFile;
	});