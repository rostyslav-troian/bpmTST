define("ContactFolder", ["terrasoft", "ext-base", "ContactFolderResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContactFolder", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContactFolder",
			singleton: true,
			uId: "8b5c01a2-59e9-40dc-855b-6e3bebddc6ee",
			name: "ContactFolder",
			...
			columns: {
				...
				Campaign: {
					uId: "4734b415-deb5-458f-a5e2-25326d8246cd",
					name: "Campaign",
		...
		return Terrasoft.ContactFolder;
	});