define("ContactForecast", ["terrasoft", "ext-base", "ContactForecastResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContactForecast", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContactForecast",
			singleton: true,
			uId: "367c714a-8bb9-4a02-b357-03c87fe7076c",
			name: "ContactForecast",
			caption: resources.localizableStrings.ContactForecastCaption,
			...
			columns: {
				...
				Contact: {
					uId: "ba8b2d0e-fa17-4688-b0b2-c020d7b1ff8a",
					name: "Contact",
		...
		return Terrasoft.ContactForecast;
	});