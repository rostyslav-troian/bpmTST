Terrasoft.configuration.Structures["BaseGridDetailV2"] = {innerHierarchyStack: ["BaseGridDetailV2NUI", "BaseGridDetailV2GoogleTagManagerMeasurements", "BaseGridDetailV2Exchange", "BaseGridDetailV2CTIBase", "BaseGridDetailV2"], structureParent: "BaseDetailV2"};
define('BaseGridDetailV2NUIStructure', ['BaseGridDetailV2NUIResources'], function(resources) {return {schemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseDetailV2", schemaName:'BaseGridDetailV2NUI',parentSchemaUId:'3052ff9d-521d-4a6d-ba92-04a2261e1ea8',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2GoogleTagManagerMeasurementsStructure', ['BaseGridDetailV2GoogleTagManagerMeasurementsResources'], function(resources) {return {schemaUId:'ca7c597b-1f6b-4089-95b0-7991beff6f13',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2NUI", schemaName:'BaseGridDetailV2GoogleTagManagerMeasurements',parentSchemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2NUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2ExchangeStructure', ['BaseGridDetailV2ExchangeResources'], function(resources) {return {schemaUId:'c4d10d1a-9c82-4159-bde1-2c7dcc7d10e5',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2GoogleTagManagerMeasurements", schemaName:'BaseGridDetailV2Exchange',parentSchemaUId:'ca7c597b-1f6b-4089-95b0-7991beff6f13',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2GoogleTagManagerMeasurements",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2CTIBaseStructure', ['BaseGridDetailV2CTIBaseResources'], function(resources) {return {schemaUId:'0a5c1c06-1968-4169-b00a-e28c4f085502',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2Exchange", schemaName:'BaseGridDetailV2CTIBase',parentSchemaUId:'c4d10d1a-9c82-4159-bde1-2c7dcc7d10e5',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2Exchange",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2Structure', ['BaseGridDetailV2Resources'], function(resources) {return {schemaUId:'c0748e93-33dc-4613-8e8e-18e29a7bbab9',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2CTIBase", schemaName:'BaseGridDetailV2',parentSchemaUId:'0a5c1c06-1968-4169-b00a-e28c4f085502',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2CTIBase",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2NUIResources', ['terrasoft'], function(Terrasoft) {
 ...
 */
define("BaseGridDetailV2NUI", ["BaseGridDetailV2Resources", "ConfigurationEnums", "ChangeLogUtilities",
	"NetworkUtilities", "ProcessModuleUtilities", "GridUtilitiesV2", "WizardUtilities", "QuickFilterModuleV2",
	"ProcessEntryPointUtilities", "EmailLinksMixin", "DuplicatesSearchUtilitiesV2", "FileImportMixin", "RightUtilities"
], function(resources, enums, changeLogUtilities) {
	return {
		messages: {
			/**
			 * @message OpenCard
		...
		mixins: {
			...
			RightUtilities: "Terrasoft.RightUtilities",
		...
		methods: {
			...
			setUpUserRecordRightsFromService: function(recordId, callback, scope) {
				...
				this.mixins.RightUtilities.getUserRecordRights(data, function(response) {
					if (response) {
			...
			onGridDataLoaded: function(response) {
				this.activeRowConfig = Terrasoft.deepClone(response.collection.initialConfig.rowConfig);
			...
			getEditPagesSandboxIds: function() {
				...
				editPages.each(function(editPage) {
					...
					sandboxIds.push(this.getMiniPageSandboxId(editPage.get("Tag")));
				}, this);
				return sandboxIds;
			},
			...
			getOpenCardConfig: function(operation, typeColumnValue, recordId) {
				const editPage = this.getEditPage(recordId, typeColumnValue);
				const schemaName = editPage.get("SchemaName");
				const cardModuleId = this.getEditPageSandboxId(editPage);
			...
			runProcess: function(config) {
				...
				Terrasoft.each(selectedItems, function(item) {
					config.parameter.parameterValue = item;
...
define('BaseGridDetailV2GoogleTagManagerMeasurementsResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseGridDetailV2GoogleTagManagerMeasurements", ["GoogleTagManagerMeasurementsUtilities"], function() {
	return {
...
define('BaseGridDetailV2ExchangeResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseGridDetailV2Exchange", ["EmailLinksMixin"], function() {
	return {
		mixins: {
			/**
...
define('BaseGridDetailV2CTIBaseResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseGridDetailV2CTIBase", ["ContextCallUtilities"], function() {
	return {
		messages: {
			"CallCustomer": {
				"mode": Terrasoft.MessageMode.PTP,
