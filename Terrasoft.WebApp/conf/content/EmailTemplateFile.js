define("EmailTemplateFile", ["terrasoft", "ext-base", "EmailTemplateFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.EmailTemplateFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.EmailTemplateFile",
			singleton: true,
			uId: "564f83f0-60f1-4da5-9d44-97fa61b3fbaf",
			name: "EmailTemplateFile",
			caption: resources.localizableStrings.EmailTemplateFileCaption,
			...
			columns: {
				...
				EmailTemplate: {
					uId: "69007759-6a70-4547-81f9-2d61339fb9ed",
					name: "EmailTemplate",
		...
		return Terrasoft.EmailTemplateFile;
	});