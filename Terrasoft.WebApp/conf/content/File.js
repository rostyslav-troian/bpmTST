define("File", ["terrasoft", "ext-base", "FileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.File", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.File",
			singleton: true,
			uId: "556c5867-60a7-4456-aae1-a57a122bef70",
			name: "File",
