define("OrderFile", ["terrasoft", "ext-base", "OrderFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.OrderFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.OrderFile",
			singleton: true,
			uId: "d75d815b-0b2e-4e33-973a-ed9a43601b44",
			name: "OrderFile",
			caption: resources.localizableStrings.OrderFileCaption,
			...
			columns: {
				...
				Order: {
					uId: "601bc0b9-c981-405b-ab34-64bd83fe670f",
					name: "Order",
