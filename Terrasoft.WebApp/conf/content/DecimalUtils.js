Terrasoft.configuration.Structures["DecimalUtils"] = {innerHierarchyStack: ["DecimalUtils"]};
define("DecimalUtils", ["ext-base", "terrasoft"], function(Ext, Terrasoft) {
	/**
	 * @class Terrasoft.configuration.DecimalUtils
	 * Provides arbitrary-precision calculations.
	 */
	Ext.define("Terrasoft.configuration.DecimalUtils", {
		extend: "Terrasoft.BaseObject",
		alternateClassName: "Terrasoft.DecimalUtils",
		 ...
		 * @throw Terrasoft.InvalidOperationException if passed operation is not supported.
		 */
	...
	return Ext.create("Terrasoft.configuration.DecimalUtils");
