Terrasoft.configuration.Structures["LeadSection"] = {innerHierarchyStack: ["LeadSection"]};
define('LeadSectionStructure', ['LeadSectionResources'], function(resources) {return {schemaUId:'cba0a32f-e0c8-4bc0-bf2f-223181e67bbf',schemaCaption: "Leads section", parentSchemaName: "", schemaName:'LeadSection',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
