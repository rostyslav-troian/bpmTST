define("KnowledgeBaseFile", ["terrasoft", "ext-base", "KnowledgeBaseFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.KnowledgeBaseFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.KnowledgeBaseFile",
			singleton: true,
			uId: "d7a8038d-63a1-42aa-bf5c-d6e0f8e97b13",
			name: "KnowledgeBaseFile",
			caption: resources.localizableStrings.KnowledgeBaseFileCaption,
			...
			columns: {
				...
				KnowledgeBase: {
					uId: "7b9de0cf-c0b9-4ac5-b635-4d9374a0e9a2",
					name: "KnowledgeBase",
		...
		return Terrasoft.KnowledgeBaseFile;
	});