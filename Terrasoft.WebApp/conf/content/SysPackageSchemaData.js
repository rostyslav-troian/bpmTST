define("SysPackageSchemaData", ["terrasoft", "ext-base", "SysPackageSchemaDataResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysPackageSchemaData", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysPackageSchemaData",
			singleton: true,
			uId: "4cec7385-4a1c-47df-89f4-97cde394e167",
			...
			columns: {
				...
				SysSchema: {
					uId: "fca145f2-e37d-4b48-a430-12a1df950704",
					name: "SysSchema",
				...
				FilterData: {
					uId: "04e67c6d-5edc-4da2-8bdb-15d4e004eeb2",
					name: "FilterData",
				...
				Data: {
					uId: "f48cc952-f3cb-4ff6-9a1b-907b23bb8e75",
					name: "Data",
				...
				SysPackage: {
					uId: "c7757822-3840-474a-a2af-be519e9732d6",
					name: "SysPackage",
				...
				InstallType: {
					uId: "33cff200-4e0a-40d9-b8f1-a1d18c9a0045",
					name: "InstallType",
				...
				UId: {
					uId: "440c72ce-05e3-46de-937d-4b67c74f9de7",
					name: "UId",
				...
				NeedInstall: {
					uId: "9c345988-f7e0-4584-b1df-a9bf816d3ccb",
					name: "NeedInstall",
				...
				LastError: {
					uId: "dcb1020e-f88b-4bda-a227-13962ceb19e5",
					name: "LastError",
		...
		return Terrasoft.SysPackageSchemaData;
	});