Terrasoft.configuration.Structures["ContactSection"] = {innerHierarchyStack: ["ContactSectionNUI", "ContactSection"]};
define('ContactSectionNUIStructure', ['ContactSectionNUIResources'], function(resources) {return {schemaUId:'81e41c40-1fc0-408b-b676-6a0d2a0565d0',schemaCaption: "Contacts section (old version)", parentSchemaName: "", schemaName:'ContactSectionNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ContactSectionStructure', ['ContactSectionResources'], function(resources) {return {schemaUId:'8e1c8978-fef6-4c92-9bec-5e6411f6493f',schemaCaption: "Contacts section (old version)", parentSchemaName: "ContactSectionNUI", schemaName:'ContactSection',parentSchemaUId:'81e41c40-1fc0-408b-b676-6a0d2a0565d0',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ContactSectionNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ContactSectionNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("ContactSectionNUI", ['Contact', "ContactSectionNUIStructure", 'sandbox', 'ContactSectionNUIResources', 'MaskHelper'],
