Terrasoft.configuration.Structures["AccountOrganizationChartDetail"] = {innerHierarchyStack: ["AccountOrganizationChartDetail"]};
define('AccountOrganizationChartDetailStructure', function() {return {type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
