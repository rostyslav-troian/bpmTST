define("ProcessSchemaType", ["terrasoft", "ext-base", "ProcessSchemaTypeResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ProcessSchemaType", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ProcessSchemaType",
			singleton: true,
			uId: "cd5b7045-5f50-4fff-9b87-a4036df2355a",
		...
		return Terrasoft.ProcessSchemaType;
	});