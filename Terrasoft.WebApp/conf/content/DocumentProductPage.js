Terrasoft.configuration.Structures["DocumentProductPage"] = {innerHierarchyStack: ["DocumentProductPage"]};
define('DocumentProductPageStructure', ['DocumentProductPageResources'], function(resources) {return {schemaUId:'10362c7d-8f4c-4aad-b733-1346b25a8e1e',schemaCaption: "Edit page - Product in document", parentSchemaName: "", schemaName:'DocumentProductPage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
