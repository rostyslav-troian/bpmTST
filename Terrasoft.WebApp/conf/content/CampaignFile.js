define("CampaignFile", ["terrasoft", "ext-base", "CampaignFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.CampaignFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.CampaignFile",
			singleton: true,
			uId: "37747baf-e32b-43d5-9c04-33b2f05338fd",
			name: "CampaignFile",
			caption: resources.localizableStrings.CampaignFileCaption,
			...
			columns: {
				...
				Campaign: {
					uId: "e227a778-e6ff-4907-a339-34c97d8016be",
					name: "Campaign",
