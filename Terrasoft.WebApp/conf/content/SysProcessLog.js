define("SysProcessLog", ["terrasoft", "ext-base", "SysProcessLogResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysProcessLog", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysProcessLog",
			singleton: true,
			uId: "ac2d8e0f-a926-4f76-a1fa-604d5eaaa1d2",
			name: "SysProcessLog",
		...
		return Terrasoft.SysProcessLog;
	});