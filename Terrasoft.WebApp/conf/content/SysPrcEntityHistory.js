define("SysPrcEntityHistory", ["terrasoft", "ext-base", "SysPrcEntityHistoryResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysPrcEntityHistory", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysPrcEntityHistory",
			singleton: true,
			uId: "3ff70cac-48aa-48e2-9b39-76952e10a18e",
			name: "SysPrcEntityHistory",
			caption: resources.localizableStrings.SysPrcEntityHistoryCaption,
			...
			columns: {
				...
				SysProcess: {
					uId: "f72f4a90-4d85-4337-bdfe-45ef7904c759",
					name: "SysProcess",
		...
		return Terrasoft.SysPrcEntityHistory;
	});