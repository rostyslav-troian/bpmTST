define("SysModuleDetail", ["terrasoft", "ext-base", "SysModuleDetailResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleDetail", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleDetail",
			singleton: true,
			uId: "fac3d18a-97ac-4d97-8997-31241d391675",
			...
			columns: {
				...
				Caption: {
					uId: "27165c5b-f3c0-453c-b2d5-1802d624cfd1",
					name: "Caption",
				...
				SysModule: {
					uId: "f9ca8dd6-d2e3-4aee-b150-adff370afc22",
					name: "SysModule",
				...
				SysModuleGrid: {
					uId: "8905fbc3-3962-4925-aab1-cdcf3f7c7acb",
					name: "SysModuleGrid",
				...
				Position: {
					uId: "4eec92e2-97d0-4f92-baf7-af8b2dee04be",
					name: "Position",
				...
				HelpContextId: {
					uId: "0595ba17-d826-4989-a9fc-8c7c0a4c7858",
					name: "HelpContextId",
		...
		return Terrasoft.SysModuleDetail;
	});