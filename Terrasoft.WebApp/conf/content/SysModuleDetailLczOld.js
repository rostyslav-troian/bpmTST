define("SysModuleDetailLczOld", ["terrasoft", "ext-base", "SysModuleDetailLczOldResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysModuleDetailLczOld", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysModuleDetailLczOld",
			singleton: true,
			uId: "8adead9e-61fe-47f6-a2aa-7a7f61029ae2",
			name: "SysModuleDetailLczOld",
			caption: resources.localizableStrings.SysModuleDetailLczOldCaption,
		...
		return Terrasoft.SysModuleDetailLczOld;
	});