define("ContentBuilderFontSet", ["terrasoft", "ext-base", "ContentBuilderFontSetResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContentBuilderFontSet", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContentBuilderFontSet",
			singleton: true,
			uId: "fe4d115e-315d-4a23-b7f0-8737a3d057e6",
			name: "ContentBuilderFontSet",
			caption: resources.localizableStrings.ContentBuilderFontSetCaption,
			...
			columns: {
				...
				Fonts: {
					uId: "91390ba7-365b-4dc9-ae47-bfd376c1558e",
					name: "Fonts",
					caption: resources.localizableStrings.FontsCaption,
					dataValueType: Terrasoft.DataValueType.TEXT,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
		...
		return Terrasoft.ContentBuilderFontSet;
	});