define("SiteEventTypeFile", ["terrasoft", "ext-base", "SiteEventTypeFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SiteEventTypeFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SiteEventTypeFile",
			singleton: true,
			uId: "457636b4-e006-43da-9958-77de3a6b0a60",
			name: "SiteEventTypeFile",
			caption: resources.localizableStrings.SiteEventTypeFileCaption,
			...
			columns: {
				...
				SiteEventType: {
					uId: "10c7a69e-4556-4aab-b286-28b1a9d4b578",
					name: "SiteEventType",
		...
		return Terrasoft.SiteEventTypeFile;
	});