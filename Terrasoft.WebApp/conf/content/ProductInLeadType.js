define("ProductInLeadType", ["terrasoft", "ext-base", "ProductInLeadTypeResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ProductInLeadType", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ProductInLeadType",
			singleton: true,
			uId: "05d4a3f0-34be-4465-aa10-db18f9ec10d1",
			name: "ProductInLeadType",
			caption: resources.localizableStrings.ProductInLeadTypeCaption,
		...
		return Terrasoft.ProductInLeadType;
	});