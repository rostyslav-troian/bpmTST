define("Brand", ["terrasoft", "ext-base", "BrandResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.Brand", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.Brand",
			singleton: true,
			uId: "fddaa2c5-f6e7-4199-a5ea-8217948ce1bd",
			name: "Brand",
