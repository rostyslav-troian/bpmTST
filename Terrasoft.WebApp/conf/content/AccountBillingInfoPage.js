Terrasoft.configuration.Structures["AccountBillingInfoPage"] = {innerHierarchyStack: ["AccountBillingInfoPage"]};
define('AccountBillingInfoPageStructure', ['AccountBillingInfoPageResources'], function(resources) {return {type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
