define("BaseEntityInStage", ["terrasoft", "ext-base", "BaseEntityInStageResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseEntityInStage", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseEntityInStage",
			singleton: true,
			uId: "86cb4c67-4231-4904-be40-b9019d87311d",
			name: "BaseEntityInStage",
			caption: resources.localizableStrings.BaseEntityInStageCaption,
		...
		return Terrasoft.BaseEntityInStage;
	});