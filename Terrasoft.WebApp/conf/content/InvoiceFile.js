define("InvoiceFile", ["terrasoft", "ext-base", "InvoiceFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.InvoiceFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.InvoiceFile",
			singleton: true,
			uId: "e7d51836-a27a-4e52-979c-29d114414085",
			name: "InvoiceFile",
			caption: resources.localizableStrings.InvoiceFileCaption,
			...
			columns: {
				...
				Invoice: {
					uId: "68b6e313-9f26-471f-9dcc-ca8200b57895",
					name: "Invoice",
