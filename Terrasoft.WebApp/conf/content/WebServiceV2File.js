define("WebServiceV2File", ["terrasoft", "ext-base", "WebServiceV2FileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.WebServiceV2File", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.WebServiceV2File",
			singleton: true,
			uId: "c13bf9f0-e1a7-4cb5-bd58-378770f615ab",
			name: "WebServiceV2File",
			caption: resources.localizableStrings.WebServiceV2FileCaption,
			...
			columns: {
				...
				WebServiceV2: {
					uId: "d8ccf516-dd47-46ae-b782-c63265455c6d",
					name: "WebServiceV2",
		...
		return Terrasoft.WebServiceV2File;
	});