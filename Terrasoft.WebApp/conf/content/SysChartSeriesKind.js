define("SysChartSeriesKind", ["terrasoft", "ext-base", "SysChartSeriesKindResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysChartSeriesKind", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysChartSeriesKind",
			singleton: true,
			uId: "a849b7de-affd-4b8f-8fce-7ab875ec42cd",
			name: "SysChartSeriesKind",
			caption: resources.localizableStrings.SysChartSeriesKindCaption,
		...
		return Terrasoft.SysChartSeriesKind;
	});