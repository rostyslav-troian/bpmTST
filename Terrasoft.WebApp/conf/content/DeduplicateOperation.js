define("DeduplicateOperation", ["terrasoft", "ext-base", "DeduplicateOperationResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.DeduplicateOperation", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.DeduplicateOperation",
			singleton: true,
			uId: "34c91fed-b922-43f7-a0d4-03aed72f7833",
			name: "DeduplicateOperation",
			caption: resources.localizableStrings.DeduplicateOperationCaption,
		...
		return Terrasoft.DeduplicateOperation;
	});