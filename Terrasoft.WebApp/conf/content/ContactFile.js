define("ContactFile", ["terrasoft", "ext-base", "ContactFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContactFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContactFile",
			singleton: true,
			uId: "e9eafee9-c4e4-4793-ad0a-003bd2c6a9b4",
			name: "ContactFile",
			caption: resources.localizableStrings.ContactFileCaption,
			...
			columns: {
				...
				Contact: {
					uId: "f442867d-73ca-49b3-a8ba-8a2566b1fc59",
					name: "Contact",
