Terrasoft.configuration.Structures["BaseEntityPage"] = {innerHierarchyStack: ["BaseEntityPageNUI", "BaseEntityPage"]};
define('BaseEntityPageNUIStructure', ['BaseEntityPageNUIResources'], function(resources) {return {schemaUId:'81c2ebad-7f20-4e71-b0c6-941b1422ba62',schemaCaption: "Base entity page", parentSchemaName: "", schemaName:'BaseEntityPageNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseEntityPageStructure', ['BaseEntityPageResources'], function(resources) {return {schemaUId:'085e9499-2d53-47f5-89e3-1c112cec017f',schemaCaption: "Base entity page", parentSchemaName: "BaseEntityPageNUI", schemaName:'BaseEntityPage',parentSchemaUId:'81c2ebad-7f20-4e71-b0c6-941b1422ba62',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseEntityPageNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseEntityPageNUIResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={};
var localizableImages={};
return {localizableStrings:localizableStrings,localizableImages:localizableImages};
});
define("BaseEntityPageNUI", [
	...
	return {
		...
		methods: {
			...
			_safeLoadDetail: function(config) {
				...
				var isAllowLoadingDetail = isDetailRendered !== true && this.get("IsEntityInitialized");
