Terrasoft.configuration.Structures["AnniversaryDetail"] = {innerHierarchyStack: ["AnniversaryDetail"]};
define('AnniversaryDetailStructure', function() {return {type:Terrasoft.SchemaType.EDIT_CONTROLS_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{attributes:[]},methods:{},schemaDifferences:function(){}};});
