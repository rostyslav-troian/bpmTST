define("FileLead", ["terrasoft", "ext-base", "FileLeadResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.FileLead", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.FileLead",
			singleton: true,
			uId: "d95c76f6-64bc-444c-9bfc-1b9cfd4f06e0",
			name: "FileLead",
			caption: resources.localizableStrings.FileLeadCaption,
			...
			columns: {
				...
				Lead: {
					uId: "900554d3-a1bb-46bf-be05-8dd9771f262c",
					name: "Lead",
