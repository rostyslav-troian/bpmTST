...
define('DcmSchemaStagePropertiesPageStructure', ['DcmSchemaStagePropertiesPageResources'], function(resources) {return {schemaUId:'0a0b7364-483f-4546-babe-c41fbd7b13d3',schemaCaption: "DcmSchemaStagePropertiesPage", parentSchemaName: "BaseProcessSchemaElementPropertiesPage", schemaName:'DcmSchemaStagePropertiesPage',parentSchemaUId:'10a8efdc-8474-4a9a-b28f-ab96ec9bbe4a',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
...
define("DcmSchemaStagePropertiesPage", ["ext-base", "terrasoft", "DcmSchemaStagePropertiesPageResources",
	...
	"EditableContainerListItemViewModel", "DcmSchemaStagePermission", "css!DcmSchemaStagePropertiesPageCSS"
	...
	return {
		...
		methods: {
			...
			initStageColumnReferenceEntitySchema: function(callback, scope) {
				var stage = this.getCurrentStage();
				var dcmSchema = stage.parentSchema;
				var schemaUId = dcmSchema.entitySchemaUId;
				if (!schemaUId) {
					callback.call(scope);
					return;
				}
				var packageUId = dcmSchema.getPackageUId();
				var schemaConfig = {
					schemaUId: schemaUId,
					packageUId: packageUId
				};
				Terrasoft.EntitySchemaManager.findBundleSchemaInstance(schemaConfig, function(schema) {
					var stageColumnUId = dcmSchema.stageColumnUId;
					if (!stageColumnUId) {
						callback.call(scope);
						return;
					}
					var columns = schema.columns;
					var column = columns.find(stageColumnUId);
					var columnReferenceSchemaUId = column.referenceSchemaUId;
					var config = {
						schemaUId: columnReferenceSchemaUId,
						packageUId: packageUId
					};
					Terrasoft.EntitySchemaManager.findBundleSchemaInstance(config, function(stageColumnSchema) {
