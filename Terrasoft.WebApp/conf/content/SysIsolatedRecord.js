define("SysIsolatedRecord", ["terrasoft", "ext-base", "SysIsolatedRecordResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysIsolatedRecord", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysIsolatedRecord",
			singleton: true,
			uId: "d0dba5bf-0248-4a93-9396-583751d97281",
			name: "SysIsolatedRecord",
			caption: resources.localizableStrings.SysIsolatedRecordCaption,
		...
		return Terrasoft.SysIsolatedRecord;
	});