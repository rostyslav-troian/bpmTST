Terrasoft.configuration.Structures["KnowledgeBaseSection"] = {innerHierarchyStack: ["KnowledgeBaseSection"]};
define('KnowledgeBaseSectionStructure', function() {return {type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
