Terrasoft.configuration.Structures["BasePageV2"] = {innerHierarchyStack: ["BasePageV2NUI", "BasePageV2DevExpress", "BasePageV2Wizards", "BasePageV2GoogleTagManagerMeasurements", "BasePageV2Deduplication", "BasePageV2ML", "BasePageV2OperatorSingleWindow", "BasePageV2"], structureParent: "BaseEntityPage"};
define('BasePageV2NUIStructure', ['BasePageV2NUIResources'], function(resources) {return {schemaUId:'d3cc497c-f286-4f13-99c1-751c468733c0',schemaCaption: "Base card schema", parentSchemaName: "BaseEntityPage", schemaName:'BasePageV2NUI',parentSchemaUId:'81c2ebad-7f20-4e71-b0c6-941b1422ba62',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2DevExpressStructure', ['BasePageV2DevExpressResources'], function(resources) {return {schemaUId:'81f83b14-525c-47ad-9a37-bf7b697ad370',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2NUI", schemaName:'BasePageV2DevExpress',parentSchemaUId:'d3cc497c-f286-4f13-99c1-751c468733c0',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2NUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2WizardsStructure', ['BasePageV2WizardsResources'], function(resources) {return {schemaUId:'12205f8d-6998-49ff-ae0d-9c67df80dff2',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2DevExpress", schemaName:'BasePageV2Wizards',parentSchemaUId:'81f83b14-525c-47ad-9a37-bf7b697ad370',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2DevExpress",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2GoogleTagManagerMeasurementsStructure', ['BasePageV2GoogleTagManagerMeasurementsResources'], function(resources) {return {schemaUId:'3dce6b13-5d69-4e5d-ac7c-0205e8dd944d',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2Wizards", schemaName:'BasePageV2GoogleTagManagerMeasurements',parentSchemaUId:'12205f8d-6998-49ff-ae0d-9c67df80dff2',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2Wizards",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2DeduplicationStructure', ['BasePageV2DeduplicationResources'], function(resources) {return {schemaUId:'92244117-272f-4a5e-8d8c-9818b258c265',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2GoogleTagManagerMeasurements", schemaName:'BasePageV2Deduplication',parentSchemaUId:'3dce6b13-5d69-4e5d-ac7c-0205e8dd944d',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2GoogleTagManagerMeasurements",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2MLStructure', ['BasePageV2MLResources'], function(resources) {return {schemaUId:'4aef9a3f-5e52-4aa6-ab74-36e106a4d17b',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2Deduplication", schemaName:'BasePageV2ML',parentSchemaUId:'92244117-272f-4a5e-8d8c-9818b258c265',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2Deduplication",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2OperatorSingleWindowStructure', ['BasePageV2OperatorSingleWindowResources'], function(resources) {return {schemaUId:'d3e2c3b2-19b8-4cd1-943c-795f543ffb08',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2ML", schemaName:'BasePageV2OperatorSingleWindow',parentSchemaUId:'4aef9a3f-5e52-4aa6-ab74-36e106a4d17b',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2ML",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2Structure', ['BasePageV2Resources'], function(resources) {return {schemaUId:'9cdd4610-4b3d-42ea-bb82-78180ae0f14c',schemaCaption: "Base card schema", parentSchemaName: "BasePageV2OperatorSingleWindow", schemaName:'BasePageV2',parentSchemaUId:'d3e2c3b2-19b8-4cd1-943c-795f543ffb08',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BasePageV2OperatorSingleWindow",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BasePageV2NUIResources', ['terrasoft'], function(Terrasoft) {
 ...
 */
define("BasePageV2NUI", ["performancecountermanager", "ChangeLogUtilities",
	...
	return {
		...
		messages: {
			...
			/**
			 * @message ScheduleReloadEntityOnRestore
			 * Schedules entity reload on next init.
			 */
		...
		methods: {
			...
			subscribeSandboxEvents: function() {
				...
				sandbox.subscribe("ValidateCard", this.onValidateCard, this, subscribersIds);
				...
				sandbox.subscribe("ScheduleReloadEntityOnRestore", this.onScheduleReloadEntity, this);
			 ...
			 * @protected
			 */
			onScheduleReloadEntity: function () {
			...
			onProcessCardSaved: function(needProcessModeToBackHistoryState) {
				...
				if (needProcessModeToBackHistoryState && !this.get("IsProcessMode")) {
					return;
				}
				if (!this.destroyed) {
			...
			onSaved: function(response, config) {
				...
				if (config && config.isSilent) {
					...
					if (config.canShowProcessCardOnSilentSave &&
							Terrasoft.Features.getIsEnabled("OpenProcessPagesInChain")) {
						this._tryShowProcessCard({
			...
			_tryShowProcessCard: function(config) {
				...
				if (Terrasoft.Features.getIsEnabled("OpenProcessPagesInChain")) {
					...
					return this.sandbox.publish("OnCardModuleSaved", message);
				}
			},
			 ...
			 * @override
			 */
			getDefaultColumnValues: function(entityColumns, callback, scope) {
				this.callParent([
					entityColumns,
					function(columns) {
...
define('BasePageV2DevExpressResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BasePageV2DevExpress", ["DevExpressPrintReportUtilities"], function() {
	return {
		mixins: {
...
define('BasePageV2WizardsResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BasePageV2Wizards", [], function() {
	return {};
});

define('BasePageV2GoogleTagManagerMeasurementsResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BasePageV2GoogleTagManagerMeasurements", ["GoogleTagManagerMeasurementsUtilities"], function() {
	return {
...
define('BasePageV2DeduplicationResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BasePageV2Deduplication", [], function() {
	return {
...
define('BasePageV2MLResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define('BasePageV2OperatorSingleWindowResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BasePageV2OperatorSingleWindow", ["terrasoft", "ServiceHelper"],
