Terrasoft.configuration.Structures["SysAdminUnitInWorkplaceDetail"] = {innerHierarchyStack: ["SysAdminUnitInWorkplaceDetail"]};
define('SysAdminUnitInWorkplaceDetailStructure', ['SysAdminUnitInWorkplaceDetailResources'], function(resources) {return {type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
