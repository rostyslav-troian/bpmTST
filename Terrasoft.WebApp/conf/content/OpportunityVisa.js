define("OpportunityVisa", ["terrasoft", "ext-base", "OpportunityVisaResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.OpportunityVisa", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.OpportunityVisa",
			singleton: true,
			uId: "ed0b26f0-6d99-4aab-8b99-37921e73f2eb",
			name: "OpportunityVisa",
			caption: resources.localizableStrings.OpportunityVisaCaption,
			...
			columns: {
				...
				Opportunity: {
					uId: "d3c7775b-e96a-4661-8da6-41911e7a69e6",
					name: "Opportunity",
		...
		return Terrasoft.OpportunityVisa;
	});