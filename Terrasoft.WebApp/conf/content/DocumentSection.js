Terrasoft.configuration.Structures["DocumentSection"] = {innerHierarchyStack: ["DocumentSection"]};
define('DocumentSectionStructure', ['DocumentSectionResources'], function(resources) {return {schemaUId:'558b2fbd-d47f-4388-84f2-dc190fd7644e',schemaCaption: "Documents section", parentSchemaName: "", schemaName:'DocumentSection',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
