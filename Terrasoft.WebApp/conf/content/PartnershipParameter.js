define("PartnershipParameter", ["terrasoft", "ext-base", "PartnershipParameterResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.PartnershipParameter", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.PartnershipParameter",
			singleton: true,
			uId: "7f8f62f1-29e5-4dd7-b206-f083a712f039",
			name: "PartnershipParameter",
			caption: resources.localizableStrings.PartnershipParameterCaption,
		...
		return Terrasoft.PartnershipParameter;
	});