Terrasoft.configuration.Structures["ProcessNotifyDemoView"] = {innerHierarchyStack: ["ProcessNotifyDemoView"]};
define('ProcessNotifyDemoViewStructure', function() {return {type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
