define("LeadTypeForecast", ["terrasoft", "ext-base", "LeadTypeForecastResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.LeadTypeForecast", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.LeadTypeForecast",
			singleton: true,
			uId: "dba8758c-3f3e-4df2-83c7-dec4ef8e22d5",
			name: "LeadTypeForecast",
			caption: resources.localizableStrings.LeadTypeForecastCaption,
			...
			columns: {
				...
				LeadType: {
					uId: "1efd0e2b-3d75-47d5-a126-8bdd9a2b1fdd",
					name: "LeadType",
		...
		return Terrasoft.LeadTypeForecast;
	});