define("VwClientAddress", ["terrasoft", "ext-base", "VwClientAddressResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwClientAddress", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwClientAddress",
			singleton: true,
			uId: "38249e0b-deeb-4f6c-a1aa-52e9961567ae",
			name: "VwClientAddress",
			caption: resources.localizableStrings.VwClientAddressCaption,
			...
			columns: {
				...
				ClientId: {
					uId: "a5f61d87-12a3-430f-a59d-979a634629df",
					name: "ClientId",
				...
				ClientType: {
					uId: "eb759b1f-fd83-4635-a260-2db30a9fb673",
					name: "ClientType",
					caption: resources.localizableStrings.ClientTypeCaption,
					dataValueType: Terrasoft.DataValueType.TEXT,
					usageType: 1,
					isInherited: false,
					isValueCloneable: true,
		...
		return Terrasoft.VwClientAddress;
	});