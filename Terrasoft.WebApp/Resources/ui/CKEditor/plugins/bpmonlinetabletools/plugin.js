...
( function() {
	...
	CKEDITOR.plugins.bpmonlinetabletools = {
		requires: 'bpmonlinetable,dialog',

		init: function( editor ) {
			var lang = editor.lang.table,
				styleParse = CKEDITOR.tools.style ? CKEDITOR.tools.style.parse : {};
	...
	CKEDITOR.plugins.add( 'bpmonlinetabletools', CKEDITOR.plugins.bpmonlinetabletools );
} )();
