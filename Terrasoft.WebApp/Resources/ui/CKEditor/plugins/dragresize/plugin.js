...
(function() {
  ...
  Resizer.prototype = {
    ...
    show: function(el) {
      ...
      var bodyDom = body.$;
      var bodyDomStyle = bodyDom.style;
      var bodyDomStyleTop = bodyDomStyle.top.replace("px", "");
      var bodyDomTop = !Ext.isEmpty(bodyDomStyleTop) ? parseInt(bodyDomStyleTop) : 0;
      var boxBodyTopDiff = box.top - bodyDomTop;
      var boxTop = boxBodyTopDiff > 0 ? boxBodyTopDiff : box.top;
      positionElement(this.container, box.left, boxTop);
