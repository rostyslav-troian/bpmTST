(function () {
	...
	GaugeChartHelper.prototype.applyGaugeConfig = function(chartConfig) {
		...
		var widthRatio = this.chart.width / 35;
		var heightRatio = this.chart.height / 50;
		var maxLabelWidth = Math.max.apply(this, labelsWidth);
		var topPadding = this.fontSize + heightRatio;
		var sidePadding = 2 * (this.fontSize + maxLabelWidth + widthRatio);
