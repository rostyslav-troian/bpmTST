/**
 * A utility class for working with the Syncfusion diagram signatures.
 */
Ext.define("Terrasoft.utils.Syncfusion.LabelUtils", {
	extend: "Terrasoft.BaseObject",
	alternateClassName: "Terrasoft.Syncfusion.LabelUtils",

	/**
	 * Utility class for working with Svg.
	 * @type {Terrasoft.Syncfusion.SvgUtils}
	 * @protected
	 */
	svgUtils: null,
	 ...
	 * @param {ej.Diagram.Svg} config.svg A utility object for working with the SVG library of the Syncfusion library.
	 ...
	 * @param {ej.Diagram.Svg} svg A utility object for working with the SVG library of the Syncfusion library.
