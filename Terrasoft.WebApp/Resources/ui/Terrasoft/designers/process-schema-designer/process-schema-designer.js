...
Ext.define("Terrasoft.Designers.ProcessSchemaDesigner", {
	 ...
	 * @private
	 */
	_addSaveCurrentVersionMenuItem: function(menuItems, resources) {
		menuItems.push(Ext.create("Terrasoft.MenuItem", {
			id: this.id + "-save-current-version-mi",
			caption: resources.SaveCurrentVersion,
			click: {
				bindTo: "forceSave"
			}
		}));
	...
	createToolBarLefContainerItems: function(actionButtonMenuItems) {
		...
		return [
			...
			},
			{
				className: "Terrasoft.Button",
				id: this.id + "-run-btn",
				caption: resources.RunButtonCaption,
				style: Terrasoft.controls.ButtonEnums.style.BLUE,
				click: {bindTo: "onRunProcessClick"},
				hint: resources.RunButtonHint,
				markerValue: "run"
			},
			{
				className: "Terrasoft.Button",
	...
	createToolbarLeftContainer: function() {
		...
		this._addSaveCurrentVersionMenuItem(menuItems, resources);
