<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetaDataGenerationErrors.aspx.cs"
	Inherits="Terrasoft.WebApp.MetaDataGenerationErrors" %>
		...
		<TS:ControlLayout runat="server" Height="100%" Padding="5" Width="100%">
			<TS:ControlLayout runat="server" Width="100%" Height="100%" DisplayStyle="Controls">
				...
				<TS:TabPanel runat="server" Height="100%" Width="100%">
					<Tabs>
						<TS:Tab runat="server" Caption="@Terrasoft.WebApp,MetaDataGenerationErrors.Caption">
							<Body>
								<TS:TreeGrid ID="MetaDataGenerationErrorsGrid" runat="server" StripeRows="True" Height="100%"
