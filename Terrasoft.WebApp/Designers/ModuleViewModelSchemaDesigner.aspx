<%@ Page Language="C#" Caption="@Terrasoft.WebApp,ModuleViewModelSchemaDesigner.Caption"
	CodeBehind="ModuleViewModelSchemaDesigner.aspx.cs" Inherits="Terrasoft.WebApp.Designers.ModuleViewModelSchemaDesigner" %>
...
<body>
	...
	<TS:ControlLayout ID="MainPanel" runat="server" Width="100%" Height="100%" IsViewPort="true"
		...
		<TS:ControlLayout ID="EditViewModelSchemaDesignerScrollPanel" runat="server" Width="100%"
				...
				<TS:TabPanel ID="SourceCodeTreePanel" runat="server" Width="100%" Height="60%" HasSplitter="true"
					...
					<Tabs>
						<TS:Tab ID="SourceCodeTreeTab" runat="server" Caption="@Terrasoft.WebApp.BaseDesigner,Schema.Caption">
							<Body>
								<TS:ControlLayout ID="ControlLayout2" runat="server" Width="100%" DisplayStyle="Topbar" Edges="0 0 1 0"
									Margins="1 0 0 0">
