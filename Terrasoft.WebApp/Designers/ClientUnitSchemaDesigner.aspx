<%@ Page Language="C#" Caption="@Terrasoft.WebApp,ClientUnitSchemaDesigner.Caption"
	CodeBehind="ClientUnitSchemaDesigner.aspx.cs" Inherits="Terrasoft.WebApp.Designers.ClientUnitSchemaDesigner" %>
...
<body>
	...
	<TS:VirtualDataSource ID="ClientUnitSchemaDataSource" runat="server">
		<AjaxEvents>
	...
	<TS:Menu runat="server" ID="SourceCode_Menu">
		<Items>
			...
			<TS:MenuItem runat="server" ID="DeleteMenuItem" Caption="@Terrasoft.WebApp.BaseDesigner,Delete.Caption"
				...
				<AjaxEvents>
					<Click OnClientEvent="removeSelectedClientUnitSchemaItem();" />
				</AjaxEvents>
			</TS:MenuItem>
	...
	<TS:ClientUnitSchemaDesignModeManager runat="server" ID="DesignModeManager" SchemaDataSourceId="ClientUnitSchemaDataSource"
	...
	<TS:ControlLayout ID="MainPanel" runat="server" Width="100%" Height="100%" IsViewPort="true"
		...
		<TS:ControlLayout ID="ToolBar" runat="server" Width="100%" Height="100%" DisplayStyle="Topbar"
			...
			<TS:Button ID="SaveButton" runat="server" Image="{Source: ResourceManager, ResourceManagerName:Terrasoft.WebApp.BaseDesigner, ResourceItemName: commondesigner-save.png}">
				<AjaxEvents>
					<Click Success="validateSources();" OnEvent="SaveButtonOnClick" ShowLoadMask="true" Timeout="9000000" />
				</AjaxEvents>
				<Menu>
			...
			<TS:Button ID="DeleteSourceCodeItem" runat="server" Caption="@Terrasoft.WebApp.BaseDesigner,Delete.Caption"
				Enabled="false">
				<AjaxEvents>
					<Click OnClientEvent="removeSelectedClientUnitSchemaItem();" ShowLoadMask="true" />
				</AjaxEvents>
			</TS:Button>
			...
			<TS:Button ID="CodeValidationButton" runat="server" Caption="@Terrasoft.WebApp.ClientUnitSchemaDesigner,SourceCodeLog.CodeValidation.Caption">
				<AjaxEvents>
		...
		<TS:ControlLayout ID="ClientUnitSchemaDesignerScrollPanel" runat="server" Width="100%"
			...
			<TS:TabPanel runat="server" ID="SourcePanel" Width="100%" Height="100%" HasSplitter="true"
				...
				<Tabs>
					...
					<TS:Tab runat="server" ID="LessTab" Caption="@Terrasoft.WebApp.BaseDesigner,LessArea.Caption">
						<Body>
							<TS:ControlLayout runat="server" Width="100%" Height="100%">
								<TS:SilverlightContainer ID="LessSyntaxMemoEdit" Width="100%" Height="100%" runat="server"
									Source="/ClientBin/Terrasoft.UI.WindowsControls.SyntaxMemo.xap">
									<ScriptableEvents>
										<TS:SilverlightScriptableEvent Name="FocusChanged" />
									</ScriptableEvents>
									<AjaxEvents>
										<CustomEvent OnClientEvent="processLessCustomEvents(sender, args)" />
									</AjaxEvents>
								</TS:SilverlightContainer>
							</TS:ControlLayout>
						</Body>
					</TS:Tab>
					<TS:Tab runat="server" ID="ImagesTab" Caption="@Terrasoft.WebApp.BaseDesigner,ImagesArea.Caption">
						<Body>
							<TS:ControlLayout ID="ImageListLayout" runat="server" Width="100%"
								DefaultMargins="10 0 0 0" FitHeightByContent="true" HorizontalAlign="Center">
							</TS:ControlLayout>
						</Body>
					</TS:Tab>
				</Tabs>
			...
			<TS:ControlLayout ID="Properties" runat="server" Width="300px" Height="100%">
				<TS:TabPanel ID="SourceCodeTreePanel" runat="server" Width="100%" Height="60%" HasSplitter="true"
					...
					<Tabs>
						<TS:Tab ID="SourceCodeTreeTab" runat="server" Caption="@Terrasoft.WebApp.BaseDesigner,Schema.Caption">
							<Body>
								...
								<TS:TreeGrid ID="SourceCodeGrid" runat="server" ToolbarVisible="false" Width="100%"
									...
									DataSourceId="ClientUnitSchemaDataSource" ContextMenuId="SourceCode_Menu">
									<AjaxEvents>
						...
						<TS:Tab ID="SourceCodeLogTab" runat="server" Caption="@Terrasoft.WebApp.ClientUnitSchemaDesigner,SourceCodeLog.SourceCodeLogGrid.Caption" Hidden="True">
							<Body>
